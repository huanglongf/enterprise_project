...
@XmlRootElement(name = "approveRAForOuterWMSResponse")
public class ApproveRAForOuterWMSResponse {

    @XmlElementRef(name = "return", namespace = "http://scm.webservice.service.erry.com", type = JAXBElement.class)
