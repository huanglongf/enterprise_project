...
public final class ScmWebServicePortType_ScmWebServiceHttpEndpoint_Client {
    protected static final Logger log = LoggerFactory.getLogger(ScmWebServicePortType_ScmWebServiceHttpEndpoint_Client.class);
    private static final QName SERVICE_NAME = new QName("http://scm.webservice.service.erry.com", "ScmWebService");

    private ScmWebServicePortType_ScmWebServiceHttpEndpoint_Client() {}
    ...
    public static void main(String args[]) throws Exception {
        ...
        ScmWebServicePortType port = ss.getScmWebServiceHttpEndpoint();
