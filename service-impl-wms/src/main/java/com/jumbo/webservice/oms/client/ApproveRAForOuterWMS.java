...
@XmlRootElement(name = "approveRAForOuterWMS")
public class ApproveRAForOuterWMS {

    @XmlElementRef(name = "args0", namespace = "http://scm.webservice.service.erry.com", type = JAXBElement.class)
