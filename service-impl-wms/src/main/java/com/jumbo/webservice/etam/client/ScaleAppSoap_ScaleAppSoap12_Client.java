...
public final class ScaleAppSoap_ScaleAppSoap12_Client {
    protected static final Logger log = LoggerFactory.getLogger(ScaleAppSoap_ScaleAppSoap12_Client.class);
    private static final QName SERVICE_NAME = new QName("http://www.bpl.com.cn/", "ScaleApp");

    private ScaleAppSoap_ScaleAppSoap12_Client() {}
    ...
    public static void main(String args[]) throws Exception {
        ...
        ScaleAppSoap port = ss.getScaleAppSoap12();
