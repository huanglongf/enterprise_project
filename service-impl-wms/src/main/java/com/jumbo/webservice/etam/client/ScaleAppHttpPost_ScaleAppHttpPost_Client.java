...
public final class ScaleAppHttpPost_ScaleAppHttpPost_Client {
    protected static final Logger log = LoggerFactory.getLogger(ScaleAppHttpPost_ScaleAppHttpPost_Client.class);
    private static final QName SERVICE_NAME = new QName("http://www.bpl.com.cn/", "ScaleApp");

    private ScaleAppHttpPost_ScaleAppHttpPost_Client() {}
    ...
    public static void main(String args[]) throws Exception {
...

        {
            ...
            java.lang.String _orderCancel_orderCode = "S120500020627";
