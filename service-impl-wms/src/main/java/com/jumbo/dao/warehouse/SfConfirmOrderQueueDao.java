...
@Transactional
public interface SfConfirmOrderQueueDao extends GenericEntityDao<SfConfirmOrderQueue, Long> {

    @NamedQuery
    List<SfConfirmOrderQueue> findExtOrder(@QueryParam("count") Long count);
