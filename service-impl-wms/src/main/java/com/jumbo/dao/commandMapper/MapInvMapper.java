...
public class MapInvMapper extends BaseRowMapper<Map<String, Map<String, Long>>> {
     ...
     public Map<String, Map<String, Long>> mapRow(ResultSet rs, int rowNum) throws SQLException {
         ...
         Map<String, Long> outMap = result.get(barCode);
         if (outMap != null) {
             outMap.put(getResultFromRs(rs, "OWNER", String.class), id);
             result.put(barCode, outMap);
         } else {
