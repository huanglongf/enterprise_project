...
import com.jumbo.wms.manager.automaticEquipment.MsgToWcsManagerImpl;
...
public class MsgToWcsThread implements Runnable {
    ...
    public MsgToWcsThread() {
        msgToWcsManager = (MsgToWcsManager) SpringUtil.getBean("msgToWcsManager");
        if (msgToWcsManager == null) {
            msgToWcsManager = (MsgToWcsManager) SpringUtil.getBean("msgToWcsManager", MsgToWcsManagerImpl.class);
        }
        hubWcsManager = (HubWcsManager) SpringUtil.getBean("hubWcsManager");
        if (hubWcsManager == null) {
            hubWcsManager = (HubWcsManager) SpringUtil.getBean("hubWcsManager", HubWcsManager.class);
        }
    }
