...
public class VmiWarehouseItochu extends AbstractVmiWarehouse {
    /**
     * 
     */
    private static final long serialVersionUID = 1315088536128511537L;
    @Autowired
    ...
    public boolean cancelSalesOutboundSta(String staCode, MsgOutboundOrderCancel msg) {
        ...
        } else if ("".equals(result) || result == null) {// 错误信息为空
