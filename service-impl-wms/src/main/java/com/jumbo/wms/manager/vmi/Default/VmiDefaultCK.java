 ...
 * 
 */
@Service("vmiDefaultCK")
public class VmiDefaultCK extends BaseVmiDefault {
    ...
    public void generateInsertVmiInventory(ExtParam ext) {
        ...
        if (!sku.getIsGift()) {
            ...
            String q = inventoryDao.findVmiInventoryQtyAndBlockQtyAndOnHoldQtyCK(sku.getId(), i.getInvOwner(), new SingleColumnRowMapper<String>(String.class));
            String[] qty = q.split(",");
            // 良品+良品不可销售
