...
import com.baozun.scm.upperservice.wms3.task.NewTaskWarningManager;
...
public class NewWarningManagerImpl extends BaseManagerImpl implements NewTaskWarningManager {
    /**
     * 
     */
    private static final long serialVersionUID = 624454592106657215L;
    protected static final Logger logger = LoggerFactory.getLogger(NewWarningManagerImpl.class);
