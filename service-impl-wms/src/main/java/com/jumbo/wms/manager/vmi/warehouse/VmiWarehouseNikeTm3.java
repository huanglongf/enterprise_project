...
public class VmiWarehouseNikeTm3 extends AbstractVmiWarehouse {
    /**
     * 
     */
    private static final long serialVersionUID = 7169696972106453655L;

    /**
     * 
     */

    protected static final Logger log = LoggerFactory.getLogger(VmiWarehouseNikeTm3.class);
    ...
    public boolean cancelSalesOutboundSta(String staCode, MsgOutboundOrderCancel msg) {
        ...
        try {
            log.debug("LF CaneleOrderToLFTask..." + Constants.VIM_WH_SOURCE_NIKE_IDS_003);
            // 调用LF接口，获取取消结果
            ConfirmResult result = idsManagerProxy.siginOrderCancelResponseToLF(msg, Constants.VIM_WH_SOURCE_NIKE_IDS_003);
            if (result != null) {
    ...
    public boolean cancelReturnRequest(Long msgLog) {
        ...
        // idsServerInformationDao.findServerInformationBySource(Constants.VIM_WH_SOURCE_NIKE_IDS_TM);
        // // 将退货信息生成指定格式
