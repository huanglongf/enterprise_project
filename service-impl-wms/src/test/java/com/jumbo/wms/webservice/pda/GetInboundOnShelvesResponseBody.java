...
/**
 * <p>Java class for getInboundOnShelvesResponseBody complex type.
 * 
...
@XmlType(name = "getInboundOnShelvesResponseBody", propOrder = {
    "status",
    "code",
    "slipCode",
    "uniqCode",
...
public class GetInboundOnShelvesResponseBody {
