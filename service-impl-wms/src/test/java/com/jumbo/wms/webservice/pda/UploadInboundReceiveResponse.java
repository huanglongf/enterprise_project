...
/**
 * <p>Java class for uploadInboundReceiveResponse complex type.
 * 
...
@XmlType(name = "uploadInboundReceiveResponse", propOrder = {
    "authResponseHeader",
    "baseResponseBody"
})
public class UploadInboundReceiveResponse {
