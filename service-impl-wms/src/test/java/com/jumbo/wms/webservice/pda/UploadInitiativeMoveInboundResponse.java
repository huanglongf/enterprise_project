...
/**
 * <p>Java class for uploadInitiativeMoveInboundResponse complex type.
 * 
...
@XmlType(name = "uploadInitiativeMoveInboundResponse", propOrder = {
    "authResponseHeader",
    "baseResponseBody"
})
public class UploadInitiativeMoveInboundResponse {
