...
/**
 * <p>Java class for pickingDatadetial complex type.
 * 
...
@XmlType(name = "pickingDatadetial", propOrder = {
    "location",
    "skuCode",
    "qty",
    "pgindex",
...
public class PickingDatadetial {
    ...
    /**
     * Gets the value of the pgindex property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the pgindex property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
