...
/**
 * <p>Java class for uploadPickingOutboundResponse complex type.
 * 
...
@XmlType(name = "uploadPickingOutboundResponse", propOrder = {
    "authResponseHeader",
    "baseResponseBody"
})
public class UploadPickingOutboundResponse {
