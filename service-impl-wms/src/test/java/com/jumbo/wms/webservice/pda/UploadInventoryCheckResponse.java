...
/**
 * <p>Java class for uploadInventoryCheckResponse complex type.
 * 
...
@XmlType(name = "uploadInventoryCheckResponse", propOrder = {
    "authResponseHeader",
    "baseResponseBody"
})
public class UploadInventoryCheckResponse {
