...
/** 
 * @ClassName: SysCoderuleDepositServiceInterface
...
@Service
public interface SysCoderuleDepositServiceInterface<T extends PersistentObject> {
	...
	/**
	 * @Title: deleteSysCoderuleDeposit
	 * @Description: TODO(删除)
	 * @param t
	 * @throws Exception
	 * @return: LmisResult<?>
	 ...
	 * @date: 2018-05-17 13:16:21
	 */
	LmisResult<?> deleteSysCoderuleDeposit(T t) throws Exception;
