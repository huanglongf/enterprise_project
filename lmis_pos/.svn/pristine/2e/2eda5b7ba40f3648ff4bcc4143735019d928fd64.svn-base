...
/** 
 * @ClassName: PosDataFileTempleteServiceInterface
 * @Description: TODO(下载上传excel模板统一记录表业务层接口类)
...
@Service
public interface PosDataFileTempleteService<T extends PersistentObject> {
	...
	/**
	 * @Title: deletePosDataFileTemplete
	 * @Description: TODO(删除下载上传excel模板统一记录表)
	 * @param t
	 * @throws Exception
	 * @return: LmisResult<?>
	 * @author: codeGenerator
	 * @date: 2018-05-29 15:38:54
	 */
	LmisResult<?> deletePosDataFileTemplete(T t) throws Exception;
