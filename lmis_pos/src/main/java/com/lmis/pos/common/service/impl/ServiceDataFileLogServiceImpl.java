...
/** 
 * @ClassName: ServiceDataFileLogServiceImpl
 * @Description: TODO(文件管存记录表业务层实现类)
...
@Service
public class ServiceDataFileLogServiceImpl<T extends ServiceDataFileLog> implements ServiceDataFileLogService<T> {
	
	@Resource(name="dynamicSqlServiceImpl")
	DynamicSqlServiceInterface<ServiceDataFileLog> dynamicSqlService;
	@Autowired
	private ServiceDataFileLogMapper<T> serviceDataFileLogMapper;
	...
	@Override
	public LmisResult<?> deleteServiceDataFileLog(T t) throws Exception {
			
		// TODO(业务校验)
		
		// 删除操作
		return new LmisResult(LmisConstant.RESULT_CODE_SUCCESS, serviceDataFileLogMapper.logicalDelete(t));
	}
