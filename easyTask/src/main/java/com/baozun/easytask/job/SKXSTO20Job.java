...
//		List<Map<String, Object>> list = skxServiceImpl.job5(a, b);
...
//		try {
//			BigExcelExport.excelDownLoadDatab(list, cMap, filehead+"斯凯奇申通20点");
//		} catch (IOException e1) {
//			e1.printStackTrace();
//		}
//		List<String> filepath = new ArrayList<>();
//		filepath.add(MailUtils.path+filehead+"斯凯奇申通20点.xlsx");
//		try {
//			MailUtils.sendMail(MailUtils.emailStr + ",346780361@qq.com", filehead+"斯凯奇申通20点" + "", "", filepath);
