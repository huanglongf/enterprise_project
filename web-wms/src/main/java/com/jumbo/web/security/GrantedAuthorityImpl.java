 ...
 * <p>
 * If compared to a custom authority which returns null from
 * {@link #getAuthority}, the <tt>compareTo</tt> method will return -1, so the
 * custom authority will take precedence.
 * 
 * @author Ben Alex
 */
public class GrantedAuthorityImpl implements GrantedAuthority, Serializable {
    ...
    private static final long serialVersionUID = 2073095150994614573L;
    private String role;
