...
@Service("packingPagePuma2_2_2")
public class PackingPagePuma2_2_2 extends BasePackingPage {

    @Override
    public String getMainTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_puma2_2_2_main.jasper";
    }
