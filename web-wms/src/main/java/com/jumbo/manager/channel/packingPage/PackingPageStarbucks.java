 ...
 *
 */
@Service("packingPageStarbucks")
public class PackingPageStarbucks extends BasePackingPage {
    
    @Override
    public String getPostpositionalMainTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_starbucks_main.jasper";
    }

    @Override
    public String getPostpositionalSubTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_starbucks_detail.jasper";
    }
