...
@Service("packingPageRayBan")
public class PackingPageRayBan extends BasePackingPage {
	
	@Override
    public String getPostpositionalMainTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_rayban_main.jasper";
    }

    @Override
    public String getPostpositionalSubTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_rayban_detail.jasper";
    }
