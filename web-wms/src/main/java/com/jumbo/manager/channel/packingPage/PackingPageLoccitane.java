 ...
 * 
 */
@Service("packingPageLoccitane")
public class PackingPageLoccitane extends BasePackingPage {

    @Override
    public String getPostpositionalMainTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_loccitane_main.jasper";
    }

    @Override
    public String getPostpositionalSubTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_loccitane_detail.jasper";
    }
