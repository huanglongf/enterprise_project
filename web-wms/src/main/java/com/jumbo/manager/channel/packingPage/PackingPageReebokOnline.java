...
@Service("packingPageReebokOnline")
public class PackingPageReebokOnline extends BasePackingPage {
    ...
    public String getPostpositionalMainTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_online_reebok_main.jasper";
    }

    @Override
    public String getPostpositionalSubTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_online_reebok_detail.jasper";
    }
