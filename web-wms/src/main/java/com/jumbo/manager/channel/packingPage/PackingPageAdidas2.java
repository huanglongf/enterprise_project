...
@Service("packingPageAdidas2")
public class PackingPageAdidas2 extends BasePackingPage {
    ...
    public String getPostpositionalMainTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_adidas_main2.jasper";
    }

    @Override
    public String getPostpositionalSubTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_adidas_detail2.jasper";
    }
