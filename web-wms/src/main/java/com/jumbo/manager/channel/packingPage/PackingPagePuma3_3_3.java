...
@Service("packingPagePuma3_3_3")
public class PackingPagePuma3_3_3 extends BasePackingPage {

    @Override
    public String getMainTemplate() {
        return PRINT_TEMPLATE_BASE_PATH + "packing_list_puma3_3_3_main.jasper";
    }
