...
<script type="text/javascript" src="<s:url value='/scripts/frame/sta_inbound.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
		...
		<div class="buttonlist">
			<table>
				<tr>
					...
					<td>
						<button loxiaType="button" id='exportZip' >确认收货数据下载</button>
					</td>
				</tr>
			</table>
			<br/>
			<button loxiaType="button" class="confirm" id="confirm">确认</button>
			<button loxiaType="button" id="printInboundDetail">打印</button>
