...
<script type="text/javascript" src="<s:url value='/scripts/frame/invoice-vmi-export.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>

</head>
<body style="background-color: #f2f2f2;" contextpath="<%=request.getContextPath() %>">
<!-- 这里是页面内容区 -->
	<p><span class="label">外包仓税控发票导出：</span></p>
	<form id="form_query">
		<table width="60%">
			<tr>
