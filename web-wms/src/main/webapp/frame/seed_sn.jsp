...
<title>SN号编辑</title>
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse/seedSn.js' includeParams='none' encode='false'/>"></script>
<style>
.showborder {
	border: thin;
}
...
<li>
	<a id="exp_li" href="#tabs-2">SN号批量导入对应关系 </a>
</li>
</ul>
	<iframe id="upload" name="upload" class="hidden"></iframe>
	<div id="tabs-2" >
	<span class="label" style="font-size: 15px;" >SN号批量导入对应关系 </span>
	...
	<table id="filterTable" width="95%">
			    ...
			    <td><b>限制导入SKU数量在1000个以下</b><a class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" href="<%=request.getContextPath() %>/warehouse/excelDownload.do?fileName=SN卡套关系导入.xls&inputPath=tplt_import_sku_seed_sn.xls">
