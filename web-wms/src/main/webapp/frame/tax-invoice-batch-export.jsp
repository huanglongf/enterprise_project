...
<script type="text/javascript" src="../scripts/frame/tax-invoice-batch-export.js"></script>
</head>
...
<!-- 这里是页面内容区 -->
	<div id="query-order-list">
		...
		<div id="pager"></div>
		<div class="buttonlist">
			<button type="button" loxiaType="button" id="export" class="confirm" ><s:text name="补开发票批量生成"></s:text></button>
		</div>
	</div>
	<div id="order-detail" class="hidden">		
		...
		<div id="dialog_ok">
			<div id="orderOp">下面按钮将完成对所选单据的操作!</div>
			<div id="batchOp">下面按钮将完成对批次：<span id="batchNo" style="font-size:30px;color:#f00"></span>的操作</div>
			<div class="buttonlist">
				<button type="button" loxiaType="button" class="confirm" id="print_All_Express">打印面单</button>
				<button type="button" loxiaType="button" class="confirm" id="export_All_Invoice">批量导出</button>
 				<button loxiaType="button" class="confirm" id="wmsInvoiceSure">确定</button>
			</div>   
		</div>
	</div> 
	<iframe id="wmsInvoiceOrderfrm" class="hidden"></iframe>
</body>
</html>