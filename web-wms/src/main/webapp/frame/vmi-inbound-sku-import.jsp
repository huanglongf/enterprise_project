...
<script type="text/javascript" src="../scripts/frame/vmi-inbound-sku-import.js"></script>
<style type="text/css">
.divFloat{
		float: left;
		margin-right: 10px;
		...
		<div id="tab_2">
			...
			<div id="searchFile">
				...
				<td> 
		            ...
		            <a loxiaType="button" href="<%=request.getContextPath() %>/warehouse/excelDownload.do?fileName=<s:text name="excel.tplt_import_vmi_create_sku"></s:text>.xls&inputPath=tplt_import_vmi_create_sku.xls"><s:text name="download.excel.template"></s:text></a>
		        </td>
				</tr></table>
			</div>
