...
<script type="text/javascript" src="<s:url value='/scripts/frame/operationcenter/salesoutbound-hand.js' includeParams='none' encode='false'/>"></script>
...
<body style="background-color: #f2f2f2;" contextpath="<%=request.getContextPath() %>">
	<div id="staDiv" staId="" trackingNo="">
		...
		<table width="90%">
			...
			<tr>
				<td id="p1" class="label hidden">包材条码</td>
				<td id="p2" class="hidden"><input id="wrapStuff" class="labelinput" loxiaType="input" mandatory="true" trim="true"/></td>
				
				<td class="label"><s:text name="label.warehouse.pl.sta.delivery"></s:text></td>
				<td id="lpcode" class="labelinput"></td>
			</tr>
			<tr id="p_tr" class="hidden">
				<td class="label"></td>
				<td>
		...
		<div id="confirm_ho_form_div2" class="hidden">
				<form id="confirm_ho_form2">
					...
					<div  class="buttonlist" >
						...
						<button id="btnDetialPrint2" loxiaType="button" class="confirm"><s:text name="button.print"></s:text> </button>
