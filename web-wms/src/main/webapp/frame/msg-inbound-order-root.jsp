...
<script type="text/javascript" src="<s:url value='/scripts/frame/msg-inbound-order-root.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
				...
				<form id="quert-form2" method="post">
						<table width="90%">
							...
							<tr>
								...
								<td class="label" width="10%">选择仓库</td>
								<td>
									<select id="selVMIWarehouse2" name="ouId" loxiaType="select">
										<option value=""><s:text name="label.wahrhouse.sta.select"></s:text> </option>
									</select>
								</td>
							</tr>		
