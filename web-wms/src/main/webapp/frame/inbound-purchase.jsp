...
<script type="text/javascript" src="<s:url value='/scripts/frame/inbound-purchase.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
...
<form id="form_query">
	<table>
		<tr>
			...
			<td width="20%"><input loxiaType="input" trim="true" name="sta.code" /></td> --%>
...
<br /><br />
<!-- 
<div class="buttonlist" id='GI_div_import' >
	<div class="divFloat">收货暂存区导入</div>
	<div class="divFloat">
		<form method="post" enctype="multipart/form-data" id="importGIForm" name="importGIForm" target="upload">
			<input type="file" loxiaType="input" id="staGIFile" name="staFile" style="width: 200px;"/>
		</form>
	</div>
	<div class="divFloat">
		<button type="button" loxiaType="button" id="importGI" class="confirm">暂存区导入</button>
	</div>
	<div class="divFloat">
		<button type="button" loxiaType="button" id="exportGI">收货暂存区导入模版下载</button>
	</div>
</div>
 -->
<br />
...
<div class="buttonlist">
	<div style="margin-bottom: 10px;">
		...
		<button id="closeSta" type="button" loxiaType="button"><s:text name="button.warehouse.inpurchase.closesta"/></button>
		<button id="cancelSta" type="button" loxiaType="button"><s:text name="button.warehouse.inpurchase.cancelsta"/></button>
...
<div class="buttonlist hidden">
	<div class="divFloat">
		<form method="post" enctype="multipart/form-data" id="importReceiveForm" name="importReceiveForm" target="upload">
			<span>PDA数量确认导入</span> <input type="file" loxiaType="input" id="goodsInfoFile" name="goodsInfoFile" style="width: 200px;"/>
		</form>
	</div>
	<div class="divFloat">
		...
		<a class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" href="/wms/warehouse/excelDownload.do?fileName=采购收货-数量确认导入.xls&inputPath=tplt_import_inbound_purchase_receive_confirm.xls" role="button">
