...
<script type="text/javascript" src="<s:url value='/scripts/frame/report-export-for-time-inventory.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
</head>														
...
<body contextpath="<%=request.getContextPath() %>">	 
	...
	<div>
		<form method="post" id="exportform" name="exportform" target="upload">
			<table width="600px">
				<tr>
					<td class="label" width="25%">时点</td>
					<td  width="25%">
						<input loxiaType="date" mandatory="true" showTime="true" name="time" />
					</td>
					<td  width="25%"></td>
					<td width="25%">
					</td>
