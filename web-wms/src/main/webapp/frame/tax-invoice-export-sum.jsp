...
<script type="text/javascript" src="../scripts/frame/tax-invoice-export-sum.js"></script>
</head>
<body style="background-color: #f2f2f2;" contextpath="<%=request.getContextPath() %>">
<!-- 这里是页面内容区 -->
<div id="tabs">
		<ul>
			<li><a href="#tabs-1">销售-税控发票导出</a></li>
			<li><a href="#tabs-2">退换货-税控发票导出</a></li>
			<li><a href="#tabs-3">配货批-税控发票导出</a></li>
		</ul>
		<div id="tabs-1">
			<!-- ------------------------ -->
	...
	<div id="order-detail" class="hidden">
		...
		<div class="buttonlist">
			...
			<button loxiaType="button" class="confirm" id="resetSoZero" title="点击使发票可以重新导出">重置发票导出</button>
...
<div id="tabs-2">
		...
		<form name="queryForm2" id="queryForm2">
			<table>
				...
				<tr>
					...
					<td width="15%">
						<%--<input loxiaType="input" trim="true" name="staCmd.owner"/> --%>
						<select id="companyshop2" name="staCmd.owner" loxiaType="select">
							<option value=""><s:text name="label.wahrhouse.sta.select"></s:text> </option>
						</select>
	...
	<div id="order-detail2" class="hidden">
		...
		<div class="buttonlist">
			...
			<button loxiaType="button" class="confirm" id="resetRaZero" title="点击使发票可以重新导出">重置发票导出</button>
...
<div id="tabs-3">
	...
	<div id="div2" class="hidden">
		...
		<div id="btnlist" class="buttonlist" >
			<button loxiaType="button" class="confirm" id="resetZeroByPickingList" title="点击使发票可以重新导出">重置发票导出</button>	
