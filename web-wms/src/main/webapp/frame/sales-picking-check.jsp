...
<script type="text/javascript" src="<s:url value='/scripts/frame/sales-picking-check.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style type="text/css">
	.tbMsg td{
		font-size : 20px;
	};
...
<div id="plDiv">
	<form id="plForm" name="plForm">
		<input type="hidden" name="plCmd.intCheckMode" value="5"/>
		<table width="70%">
			<tr>
...
<div id="checkDiv" class="hidden">
	...
	<table width="500px">
		<tr>
			...
			<td width="70%">
				<input id="skuBarCode" loxiaType="input"  trim="true" style="height:34px;font-size:32px;width: 400px;"/>
			</td>
		</tr>
	</table>
	<br/>
