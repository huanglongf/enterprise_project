...
<script type="text/javascript" src="<s:url value='/scripts/frame/sta-inboundhand-starbucks.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
...
<!-- 这里是页面内容区 -->
	...
	<div id="divDetial" class="hidden">
	  ...
	  <div class="buttonlist">
			<table>
				<tr>
					<td>SKU条码：</td>
					<td><input type="text" loxiaType="input" trim="true" name="sta.barCode"  id="addBarCode"></input></td>
					<td><input type="text"  trim="true"  id="hiddenSnCheckMode" class="hidden"></input></td>
				</tr>
				<tr>
				<td>卡券起始号：</td>
				<td><input type="text" loxiaType="input" trim="true"   id="startNum"></input></td>
				<td>卡券终止号：</td>
				<td><input type="text" loxiaType="input" trim="true"   id="stopNum"></input></td>
				</tr>
			</table>
			
		</div>
		
			<table id="tbl_add_list"></table>
			<br />
		<div class="buttonlist">
			<table>
				<tr>
					<td><button loxiaType="button" class="confirm" id="confirm">确认本次收货</button></td>
				</tr>
	...
	<div id="buttonlist">
		<table>
			<tr><td><button loxiaType="button" id="back">返回</button></td></tr>
		</table>
	</div>
