...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<s:url value='/scripts/frame/compensation/compensation-check.js"' includeParams='none' encode='false'/>"></script>
	</head>
	   ...
	   <jsp:include page="/frame/compensation/compensation-querywarehouse.jsp"></jsp:include>
		...
		<div id="showDetail" class="hidden">
			...
			<br /><br />
				...
				<div class="buttonlist">
					<div id="div_dispose">
						<button id="dispose" type="button" loxiaType="button" class="confirm">审核索赔</button>
					</div>
					</br>
