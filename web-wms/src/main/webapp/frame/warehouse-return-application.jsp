...
<title>退货申请</title>
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse-return-application.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
</head>
