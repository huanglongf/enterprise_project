...
<script type="text/javascript" src="<s:url value='/scripts/frame/automaticEquipment/check-space-role.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
			...
			<form id="form_info">
				<table>
					...
					<tr>
						...
						<td width="10%"></td>
						<td class="label" width="10%">工作台编码：</td>
						...
						<option value="8">云仓次日</option>
						<option value="9">云仓隔日</option>
					</select></td>
						<td width="10%"></td>
						<td class="label" width="10%">指定商品：(多个编码，用逗号隔开)</td>
						<td width="20%"><textarea style="height: 50px;" id=skuCodes name="skuCodes"></textarea>
						<!-- <input loxiaType="input" trim="true"   id = "skuCodes" name="skuCodes"/> -->
						</td>
					</tr>
					<tr>
						<td width="10%"></td>
					...
					<tr>
						<td class="label" width="10%">是否预售订单：</td>
						<td width = "160px">
