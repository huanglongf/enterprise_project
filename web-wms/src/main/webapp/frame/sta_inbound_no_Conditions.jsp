...
<script type="text/javascript" src="<s:url value='/scripts/frame/sta_inbound_no_Conditions.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
		...
		<form id="queryForm" name="queryForm">
			<table width="700px">
				...
				<tr>
					...
					<td>
						<input type="text" loxiaType="input" id="refShlpCode" trim="true" name="sta.refSlipCode"></input>
					</td>
				</tr>
				<tr>
