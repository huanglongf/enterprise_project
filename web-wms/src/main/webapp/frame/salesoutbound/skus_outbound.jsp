...
<title>多件出库</title>
<script type="text/javascript" src="<s:url value='/frame/salesoutbound/skus_outbound.js"' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
</head>
...
<input id="dialog_is_pre2" type="hidden" value="0" />
	...
	<div id="step1_1" step="1_1">
		...
		<div align="center" style="width:1300px;margin:20px auto;overflow:hidden">
			<div id="step1_2" step="1_2">
				<p id="P_1">
					<label class="font-L fl">商品：</label><input id="txtScanSku" type="text" index="1_2" class="scan" />
					<button id="btnScanSku" type="button" class="btn btn-primary btn-XL">确认</button>
					<label class="font-L fl" id="LabelDeviceNumber">设备号：</label><input id="txtDeviceNumber" type="text"  class="scan" value="${RFIDCode}" />
					<button id="btnDeviceNumber" type="button" class="btn btn-primary btn-XL">确认</button>
					<label class="font-L fl" id="LabelDeviceOk">OK码：</label><input id="txtDeviceOk" type="text" index="1_2" class="scan" />
					<button id="btnDeviceOk" type="button" class="btn btn-primary btn-XL">确认</button>
					
					<label class="font-L fl" id="LabelRfidCode">RFID号码：</label>
					<button id="btnRfidCode" type="button" class="btn btn-primary btn-XL">确认</button>
					
					<label class="font-L fl" id="LabelMaterialSingle">耗材：</label><input id="txtMaterialSingle" type="text" index="1_2" class="scan" />
					<button id="btnMaterialSingle" type="button" class="btn btn-primary btn-XL">确认</button>
					
					<button id="btnShort" type="button" class="btn btn-danger btn-XL">报缺</button>
					<button id="btnPartly" type="button" class="btn btn-info btn-XL">部分发货</button>
				</p> 
				<p id="P_2">
  ...
  <div id="dialogMaterial">
  		<p>
		  	<label>耗材：</label><input id="material" type="text" index="1_2" class="scan" />
			<button id="btnMaterial" type="button" class="btn btn-primary btn-XL">确认</button>
		</p>
  </div>
</body>
