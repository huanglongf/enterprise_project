...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<s:url value='/scripts/frame/sales-dispatch-list-query.js"' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
		...
		<div id="showList">
			    ...
			    <form id="plForm" name="plForm">
					<table width="70%">
						...
						<tr>
	                        ...
	                        <td width="20%">
	                            <s:select list="plStatus" loxiaType="select" listKey="optionKey" listValue="optionValue" name="plCmd.intStatus" id="status" headerKey="" headerValue="%{pselect}"/>
	                        </td>
						</tr>
						<tr>
			...
			<div style="margin-bottom: 10px;">
				...
				<input id="refSlipCode" class="refSlipCode" loxiaType="input" style="width: 150px" trim="true"/>&nbsp; 
					...
					<input id="iptPlCode" loxiaType="input" style="width: 150px" trim="true"/>
			</div>
			<div>
