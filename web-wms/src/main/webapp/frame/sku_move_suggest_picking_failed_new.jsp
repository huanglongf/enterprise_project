...
<title>配货失败建议</title>
<script type="text/javascript" src="<s:url value='/scripts/frame/sku_move_suggest_picking_failed_new.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
