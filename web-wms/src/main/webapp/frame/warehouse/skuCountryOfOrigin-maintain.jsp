...
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse/skuCountryOfOrigin-maintain.js' includeParams='none' encode='false'/>"></script>
				...
				<tr>
					...
					<td>
						<form method="post" enctype="multipart/form-data" id="importForm2" name="importForm" target="upload">
							...
							<a loxiaType="button" href="<%=request.getContextPath() %>/warehouse/excelDownload.do?fileName=商品产地导入.xls&inputPath=skucounttryoforigin.xls">模板文件下载</a>
