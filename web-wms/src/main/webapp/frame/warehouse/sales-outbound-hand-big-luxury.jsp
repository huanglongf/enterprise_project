...
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse/sales-outbound-hand-big-luxury.js' includeParams='none' encode='false'/>"></script>
	...
	<div id="staDiv" staId="" trackingNo="">
		...
		<table width="90%">
			...
			<tr>
				...
				<td><button type="button" loxiaType="button" class="confirm" id="printLogisticsOrder">打印物流面单</button></td>
				<td></td>
			</tr>
			<tr>
