...
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse/sales-outbound-hand.js' includeParams='none' encode='false'/>"></script>
...
<div id="dialog_is_pre" style="display:none;">
	...
	<div id="staDiv" staId="" trackingNo="" isOtwoO="">
		<div id="outbound">
		<table width="90%">
			<tr>
