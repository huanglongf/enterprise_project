...
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse/pickinglist-print-status.js' includeParams='none' encode='false'/>"></script>
...
<div id="div3">
	<p>
			<button loxiaType="button" class="confirm" id="batch_btnSoInvoice"><s:text name="button.export.invoice"></s:text></button>
			<button loxiaType="button" class="confirm" id="batch_printPickingList"><s:text name="button.pl.print"/></button>
			<button loxiaType="button" id="batch_printPickingListNew2"><s:text name="button.pl.print2"/></button>
			<button loxiaType="button" class="confirm" id="batch_printTrunkPackingList"><s:text name="button.pg.print"></s:text></button>
			<select loxiaType="select" name="batch_pickZoneCode" id="batch_pickZoneCode"  style="width:150px;">
					 <option value="">--请选择区域--</option>
			 </select>
		</p>
		<p>
			<button loxiaType="button" class="confirm" id="batch_printDeliveryInfo"><s:text name="button.trans.print"></s:text></button>
			<button loxiaType="button" class="confirm"  id="batch_printStart" >打印开始</button>
			<button loxiaType="button" class="confirm"  id="batch_printDone" >打印完成</button>
			<button loxiaType="button" class="confirm"  id="printPdaBarCodeS" >打印PDA拣货条码</button>
			</p>
	</div>
<!--  <div class="hidden">
