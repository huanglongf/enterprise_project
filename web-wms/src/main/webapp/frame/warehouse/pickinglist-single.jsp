...
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse/pickinglist-single.js' includeParams='none' encode='false'/>"></script>
...
<body style="background-color: #f2f2f2;" contextpath="<%=request.getContextPath() %>">
	...
	<form action="/generationPendingList.json" method="post" id="query-form">
		...
		<table id="filterTable" width="95%">
				...
				<tr>
					...
					<td>
						<select id="selIsNeedInvoice" name="isNeedInvoice" loxiaType="select" id="isNeedInvoice">
				...
				<tr>
					...
					<td>
						<input loxiaType="input" trim="true" name="sta.memo" id="sta_memo"/>
					</td>
				...
				<tr>
				   <td class="label" width="13%">一键创批仓库区域</td>
				   <td  width="20%">
				   		<select name="district" id="district" loxiaType="select">
						</select>
				   </td>
				   
				   <td class="label" width="13%">一键创批系统库区区域</td>
				   <td  width="20%">
				   		<select name="wh_district" id="wh_district" loxiaType="select">
						</select>
				   </td>
				   <td colspan="2"></td>
				</tr>
	...
	<div class="buttonlist">
		...
		<button type="button" loxiaType="button" id="createPicking">一键创批</button>
		<br /><br />
