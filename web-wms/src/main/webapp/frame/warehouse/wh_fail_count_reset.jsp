...
<title></title>
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse/wh_fail_count_reset.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
...
<!-- 这里是页面内容区 -->
	...
	<div id="div-sta-list">
		<form id="form_query" method="post">
			<table>
				<tr>
					<td class="label">前置单据号</td>
					<td>
						<input loxiaType="input" trim="true" name="queueStaCommand.ordercode" id="ordercode" maxlength="80"/>
					</td>
							...
							<tr>
								<td>
									<div style="float: left;">
										<select id="companyshop" name="queueStaCommand.owner" loxiaType="select" style="width: 236px; height: 24px;">
					...
					<td style="width: 50px;"><input loxiaType="input" style="width: 50px" name="queueStaCommand.numberUp" id="numberUp" /></td>
					<td class="label" style="width: 5px;">━</td>
					<td><input loxiaType="input" style="width: 50px" name="queueStaCommand.amountTo" id="amountTo" /></td>
		...
		<div class="buttonlist">
			...
			<button loxiaType="button" class="confirm" id="resetTo99">重置次数 :&nbsp;99</button>
		</div>
	</div>
