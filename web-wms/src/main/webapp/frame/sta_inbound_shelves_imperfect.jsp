...
<script type="text/javascript" src="<s:url value='/scripts/frame/sta_inbound_shelves_imperfect.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
...
<!-- 这里是页面内容区 -->
	<div id="divHead">
		<form id="queryForm" name="queryForm">
			<table width="700px">
				...
				<tr>
					...
					<td width="15%"><input loxiaType="date" name="startTime" showTime="true"></input></td>
					<td width="10%" class="label" style="text-align: center;"><s:text name="label.warehouse.pl.to"></s:text> </td>
					<td width="15%"><input loxiaType="date" name="endTime" showTime="true"/></td>
				</tr>
			</table>
		</form>
		...
		<div>
			<table>
				<tr>
					...
					<td>
						<button loxiaType="button" class="confirm" id="impDiff">导入上架数据</button>
					</td>
					<td>
						<button loxiaType="button" id="expDiff">导出待入库商品</button>
					</td>
				</tr>
			</table>
			<br/>
		...
		<br />
		<button loxiaType="button" class="confirm hidden" id="createMergeShelves">创建合并上架单</button>
	</div>
...
<!-- 		<div class="buttonlist" id="inGI">
			<button loxiaType="button" class="confirm" id="GIinbound">入库收货上架到暂存区</button>
		</div> -->
	</div>
	<div id="divMergeDetial" class="hidden">
		<font class="label">合并上架</font>
		<table id="tbl_merge_list"></table>
		<div id="pager2"></div>
		<br/>
		<div class="buttonlist">
			<table>
				<tr>
					...
					<td>
						<button loxiaType="button" class="confirm" id="mergeImpDiff">导入上架数据</button>
					</td>
					<td>
						<button loxiaType="button" id="mergeExpDiff">导出待入库商品</button>
						<button loxiaType="button" id="mergeBack">返回</button>
					</td>
				</tr>
			</table>
			<br/>
	...
	<div id="dialogPdaLog">
		...
		<div id="pager2"></div>
		<div class="buttonlist">
			<button loxiaType="button"  class="confirm" id="close">关闭</button>
		</div>
	</div>
