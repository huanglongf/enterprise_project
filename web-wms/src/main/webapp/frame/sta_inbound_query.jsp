...
<script type="text/javascript" src="<s:url value='/scripts/frame/sta_inbound_query.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
...
<!-- 这里是页面内容区 -->
	...
	<div id="divDetial" class="hidden">
		...
		<div id="detail_tabs">
			<ul>
				<li><a href="#m2_tabs-1">入库商品明细</a></li>
				<li><a href="#m2_tabs-2">入库SN号</a></li>
			</ul>
			<div id="m2_tabs-1">
				<table id="tbl_inbound_line_list"></table>
				<div id="pagerDetail"></div>
			</div>
			<div id="m2_tabs-2">
				<table id="tbl_inbound_sn"></table>
				<div id="pagerSn"></div> 
			</div>
		</div>
		<div class="buttonlist">
			<button loxiaType="button" class="confirm" id="exportPoReport">仓库收货确认单导出</button>
