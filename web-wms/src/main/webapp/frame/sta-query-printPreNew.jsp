...
<script type="text/javascript" src="<s:url value='/scripts/frame/sta-query-printPreNew.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
...
<body style="background-color: #f2f2f2;" contextpath="<%=request.getContextPath() %>">
	...
	<%@include file="../common/include-print.jsp"%>
</body>
</html>