...
<script type="text/javascript" src="<s:url value='/scripts/frame/VMI-flitting-query.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
</head>
<body style="background-color: #f2f2f2;" contextpath="<%=request.getContextPath() %>">
 <s:text id="pselect" name="label.please.select"/>
	   ...
	   <form id="staForm" name="staForm">
		<table>
			...
			<tr>
				...
				<td >
						<select id="selMainShopId" name="sta.owner" loxiaType="select">
							<option value=""></option>
						</select>
				</td>
				<td>
				...
				<td width=150>
						<select id="selTargetShopId" name="sta.addiOwner" loxiaType="select">
							<option value=""></option>
						</select>
				</td>
				<td>
	...
	<div id="details" class="hidden">
			...
			<tr>
				<td class="label">源店铺</td>
				<td id="owner_OuName"></td>
				<td class="label">目标店铺</td>
                <td id="addiOwner_OuName"></td>
			</tr>
			<tr>
