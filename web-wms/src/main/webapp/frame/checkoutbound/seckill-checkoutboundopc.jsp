...
<script type="text/javascript" src="<s:url value='/scripts/frame/checkoutbound/seckill-checkoutboundopc.js' includeParams='none' encode='false'/>"></script>
<style>
.showborder {
	border: thin;
}
