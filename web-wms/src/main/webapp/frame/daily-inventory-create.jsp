...
<script type="text/javascript" src="<s:url value='/scripts/frame/daily-inventory-create.js"' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
