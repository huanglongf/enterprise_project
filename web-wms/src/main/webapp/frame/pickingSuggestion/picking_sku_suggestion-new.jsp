...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<%-- <script type="text/javascript" src="<s:url value='/frame/pickingSuggestion/cookies.js"' includeParams='none' encode='false'/>"></script> --%>
		<script type="text/javascript" src="<s:url value='/frame/pickingSuggestion/picking_sku_suggestion-new.js"' includeParams='none' encode='false'/>"></script>
		<style type="text/css">
			.tips{
	...
	<body style="background-color: #f2f2f2;" contextpath="<%=request.getContextPath() %>">
		<div id="picking-list">
				...
				<table width="80%" >
					<tr>
						...
						<td width="20%"><select id="printName" loxiaType="select" name="printName">
						</select></td>
					</tr>
				</table>
		...
		<div id="detail" class="hidden" >
			...
			<div style="float:left;width:450px;padding-right:20px;border-right:1px #9bb3cd">
			...
			<div style="float:right;width:300px">
			   <table cellspacing="0"  border="1" id="tbl-detail-list3" style="border-bottom:solid ;border:1px;font-size: 20px; ">
