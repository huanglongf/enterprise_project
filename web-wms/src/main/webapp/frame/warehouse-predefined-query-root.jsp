...
<script type="text/javascript" src="<s:url value='/scripts/frame/warehouse-predefined-query-root.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
	...
	<table>
		<tr>
			...
			<td><input loxiaType="input" trim="true" name="sta.refSlipCode" /></td>
				...
				<td>
					<select id="selVMIWarehouse" name="ouId" loxiaType="select">
