...
<script type="text/javascript" src="<s:url value='/scripts/frame/vmi-operation-query.js' includeParams='none' encode='false'><s:param name="version"><s:property value="#VERSION" /></s:param></s:url>"></script>
<style>
.showborder {
	border: thin;
}
...
<div class="district">
	...
	<div class="buttonlist">
		<div style="margin-bottom: 10px;">
			...
			<%-- <button id="closeSta" type="button" loxiaType="button" class="confirm"><s:text name="button.warehouse.inpurchase.closesta"/></button> --%>
		...
		<!-- <div id="invoice1" class="">
			...
			<table width="70%">
				<tr>
					...
					<td  width="30%">
						<input loxiaType="input" id="invoice1_invoiceNumber" readonly="readonly" />
					</td>
					<td colspan="2" id="invoice1_select2TD"  class='hidden'>
						<select  loxiaType="select" name="numberSelect" id="invoice1_selectInv">
							<option value="">请选择发票号</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td  width="30%">
						<input loxiaType="number" mandatory="true" decimal="2"  readonly="readonly" id="invoice1_dutyPercentage" trim="true" />
					</td>
					<td width="15%" class="label">
						其他系数
					</td>
					<td  width="30%">
						<input loxiaType="number" mandatory="true" decimal="2"  readonly="readonly" id="invoice1_miscFeePercentage" trim="true"  />
					</td>
				</tr>
			</table>
	</div> -->
