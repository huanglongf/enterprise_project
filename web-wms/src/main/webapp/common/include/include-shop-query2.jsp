...
<script type="text/javascript" src="<s:url value='/scripts/common/include/include-shop-query2.js' includeParams='none' encode='false'/>"></script>
<div id="shopQueryDialog" style="display: none;">
	<form id="shopQueryDialogForm" name="shopQueryDialogForm">
		<table width="95%">
			<tr>
				...
				<td>
					<input loxiaType="input" trim="true" name="shopName"/>
				</td>
			</tr>
		</table>
	</form>
