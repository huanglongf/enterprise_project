...
<script type="text/javascript" src="<s:url value='/scripts/common/include/include-skuame-query.js' includeParams='none' encode='false'/>"></script>
	...
	<form id="shopQueryDialogForm" name="shopQueryDialogForm">
		<table width="95%">
			<tr>
				...
				<td>
					<input loxiaType="input" trim="true" name="name" id="name"/>
				</td>
			</tr>
		</table>
	</form>
