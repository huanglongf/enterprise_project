...
$j(document).ready(function (){
	...
	postData['invcheck.status']="CHECKWHINVENTORY";
	...
	$j("#confirmType").click(function(){
		...
		var rs = loxia.syncXhrPost($j("body").attr("contextpath") + "/managercheck.json?code="+$j("#code").text());
		if(rs && rs.rs=='success'){
			jumbo.showMsg("盘点确认成功！");
			 //location.reload();
			 window.location.href=baseUrl+"/warehouse/invckmanagers.do"; 
		}else{
