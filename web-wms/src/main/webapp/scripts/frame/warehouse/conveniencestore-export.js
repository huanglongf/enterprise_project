...
$j(document).ready(function (){
	...
	$j("#export").click(function(){
		...
		var url = loxia.getTimeUrl($j("body").attr("contextpath") + "/warehouse/exportconveniencestoreorderinfo.do?fromDate=" + fromDate + "&endDate=" + endDate);
		$j("#frmExport").attr("src",url);
	});
