...
<body contextpath="<%=request.getContextPath() %>">
	<div class="body-all">
			...
			<div class="admin-content">
				...
				<div class="am-tabs " data-am-tabs="" id="picking5">
					<div class="am-tabs-bd" style="-webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
						<div class="am-tab-panel am-fade  am-in" >
							...
							<!-- <div class="am-g">
								<div style="font-size:16px;">该库位此商品应拣[<font id="sortPqty"></font>]件</div>
							</div>
							<div class="am-g">
								<div style="font-size:16px;">当前仅拣货[<font id="sortSqty"></font>]件</div>
							</div>
							<div class="am-g">
								<div style="font-size:16px;">是否确定短拣[<font id="sortQqty"></font>]件</div>
							</div> -->
				...
				<div class="am-tabs " data-am-tabs="" id="picking6">
					<div class="am-tabs-bd" style="-webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
						...
						<div class="btn-center">
							<button type="button" class="am-btn am-btn-primary btn-right-margin" id="pbShortOK">确认短拣</button>
				...
				<div class="am-tabs " data-am-tabs="" id="picking8">
					<div class="am-tabs-bd" style="-webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
						<div class="am-tab-panel am-fade  am-in" >
							<div class="am-g">
								<div  style="font-size:15px;" >共拣出<font id="countBoxQty" style="font-size:15px;"></font>个周转箱</div>
							</div>
							<div class="am-g">
								<div  style="font-size:15px;" >请确保未漏箱</div>
							</div>
						</div>
						<div class="btn-center">
							<button type="button" class="am-btn am-btn-primary btn-right-margin" id="countBoxQtyOk">确认</button>
							<button type="button" class="am-btn am-btn-primary " id="countBoxQtyNo">漏箱</button>
						</div>
							<div>
								<table class="am-table am-table-bordered" style="width:200px;">
									<tbody id="bindBoxList"></tbody>
								</table>
							</div>
					</div>
		...
		<script type="text/javascript" src="./picking/pda_picking.js"></script>
