 ...
 * 接口/类说明：优先发货城市配置
 * 
 * @ClassName: PriorityShippedCityConfig
 * @author LuYingMing
 * @date 2016年8月24日 下午5:36:00
 */
@Entity
@Table(name = "T_WH_PRIORITY_CITY_CONFIG")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION, dynamicUpdate = true)
public class PriorityShippedCityConfig extends BaseModel {

    private static final long serialVersionUID = -8776305463246736629L;
