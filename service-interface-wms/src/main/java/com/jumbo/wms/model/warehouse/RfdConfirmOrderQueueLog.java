...
@Entity
@Table(name = "T_RFD_CONFIRM_ORDER_QUEUE_LOG")
public class RfdConfirmOrderQueueLog extends BaseModel {

	private static final long serialVersionUID = -2093557491096832532L;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_RFDCQQ", sequenceName = "S_RFD_CONFIRM_ORDER_QUEUE_LOG", allocationSize = 1)
