 ...
 */
@Entity
@Table(name = "T_WH_ORDER_INVOICE_OMS_ARCHIVE")
public class WmsOrderInvoiceOmsArchive extends BaseModel {
	 /**
	 * 
	 */
	private static final long serialVersionUID = 5576970520658932533L;
	/**
     * ID
     */
    private Long id;
