 ...
 */
@Entity
@Table(name = "T_Levis_YX_TRANSFER_OUT")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class LevisYxTransferOut extends BaseModel {
    
    private static final long serialVersionUID = 1055043671747962686L;
    /*
     * PK
     */
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_LEVIS_YX_TRANSFER_OUT", sequenceName = "S_T_LEVIS_YX_TRANSFER_OUT", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_LEVIS_YX_TRANSFER_OUT")
    public Long getId() {
        return id;
    }
