 ...
 */
@Entity
@Table(name = "T_IT_SKU_PRICE_DATA")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class SkuPriceData extends BaseModel {
    /**
	 * 
	 */
    private static final long serialVersionUID = 8072735543652926750L;
    private Long id;
    ...
    private Integer mode; // 0-seasonal price;1-promtional price;2-pre-sale
                          // price
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_IT_SKU_PRICE_DATA", sequenceName = "S_IT_SKU_PRICE_DATA", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IT_SKU_PRICE_DATA")
    public Long getId() {
        return id;
    }
