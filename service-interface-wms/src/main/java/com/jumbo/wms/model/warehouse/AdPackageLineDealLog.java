 ...
 */
@Entity
@Table(name = "t_ad_package_line_deal_log")
public class AdPackageLineDealLog extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "s_t_ad_package_line_deal_log", sequenceName = "s_t_ad_package_line_deal_log", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "s_t_ad_package_line_deal_log")
    public Long getId() {
        return id;
    }
