 ...
 */
@Entity
@Table(name = "T_CXC_CONFIRM_ORDER_QUEUE_LOG")
public class CxcConfirmOrderQueueLog extends BaseModel {



    private static final long serialVersionUID = -5724091088216716537L;
    /**
     * PK
     */
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_CXC_ORDER_QUEUE_LOG", sequenceName = "S_CXC_CONFIRM_ORDER_QUEUE_LOG", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_CXC_ORDER_QUEUE_LOG")
	public Long getId() {
		return id;
	}
