...
@Entity
@Table(name = "t_wh_pda_hand_Over_log")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION, dynamicUpdate = true)
public class PdaHandOverLog extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_PDA_HAND_OVER_LOG", sequenceName = "s_t_wh_pda_hand_over_log", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_PDA_HAND_OVER_LOG")
    public Long getId() {
        return id;
    }
