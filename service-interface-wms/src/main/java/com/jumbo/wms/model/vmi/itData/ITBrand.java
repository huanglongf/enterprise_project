...
@Entity
@Table(name = "T_IT_BRAND")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class ITBrand extends BaseModel {
    /**
	 * 
	 */
    private static final long serialVersionUID = 1392706268497666931L;
    private Long id;
    private String code;
    private String name;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_BRAND", sequenceName = "S_IT_BRAND", allocationSize = 1)
