...
@Entity
@Table(name = "T_WH_CONFIRM_ORDER")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION, dynamicUpdate = true)
public class WmsConfirmOrderQueue extends BaseModel {
     ...
     * @return
     */
    private String mqStatus; // 1 或 null:未推送 10:已推送
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_T_WH_CONFIRM_ORDER", sequenceName = "S_T_WH_CONFIRM_ORDER", allocationSize = 1)
    @GeneratedValue(generator = "SEQ_T_WH_CONFIRM_ORDER", strategy = GenerationType.SEQUENCE)
    public Long getId() {
        return id;
    }
