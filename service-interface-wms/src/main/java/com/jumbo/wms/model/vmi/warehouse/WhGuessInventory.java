...
@Entity
@Table(name = "T_WH_GUESS_INVENTORY")
public class WhGuessInventory extends BaseModel{

    /**
     * 
     */
    private static final long serialVersionUID = -1693793602704714024L;
    ...
    @Id
    @SequenceGenerator(name = "T_WH_GUESS_INVENTORY_ID_GENERATOR", sequenceName = "S_T_WH_GUESS_INVENTORY", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "T_WH_GUESS_INVENTORY_ID_GENERATOR")
