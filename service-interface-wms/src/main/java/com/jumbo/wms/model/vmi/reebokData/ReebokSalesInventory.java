...
@Entity
@Table(name = "T_REEBOK_SALES_INVENTORY")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class ReebokSalesInventory extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_WHL", sequenceName = "S_T_REEBOK_SALES_INVENTORY", allocationSize = 1)
