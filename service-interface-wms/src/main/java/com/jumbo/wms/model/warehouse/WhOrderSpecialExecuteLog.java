 ...
 */
@Entity
@Table(name = "T_WH_ORDER_SPECIAL_EXECUTE_LOG")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class WhOrderSpecialExecuteLog extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_ORDER_SPECIAL_EXECUTE_LOG", sequenceName = "S_ORDER_SPECIAL_EXECUTE_LOG", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_ORDER_SPECIAL_EXECUTE_LOG")
    public Long getId() {
        return id;
    }
