...
@Entity
@Table(name = "T_ZTO_CONFIRM_ORDER_QUEUE_LOG")
public class ZtoConfirmOrderQueueLog extends BaseModel {
    /**
     * 
     */
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_ZTOCQQ", sequenceName = "S_T_ZTO_CONFIRM_QUEUE_LOG", allocationSize = 1)
