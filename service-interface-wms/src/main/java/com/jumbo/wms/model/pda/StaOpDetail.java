...
/**
 * 
 * @author lizaibiao 作业单操作明细
 * 
 */
@Entity
@Table(name = "t_wh_sta_op_detail")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class StaOpDetail extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_WHL", sequenceName = "S_T_WH_STA_OP_DETAIL", allocationSize = 1)
