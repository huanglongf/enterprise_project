...
@Entity
@Table(name = "T_NIKE_STOCK_RECEIVE")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class NikeStockReceive extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_NikeStockReceive", sequenceName = "S_T_NIKE_STOCK_RECEIVE", allocationSize = 1)
