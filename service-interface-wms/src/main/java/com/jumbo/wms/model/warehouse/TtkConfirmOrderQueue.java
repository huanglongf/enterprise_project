 ...
 */
@Entity
@Table(name = "T_TTK_CONFIRM_ORDER_QUEUE")
public class TtkConfirmOrderQueue extends BaseModel {

    private static final long serialVersionUID = 8647078631338743873L;
    /**
     * PK
     */
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_TTK_CONFIRM_ORDER_QUEUE", sequenceName = "S_T_TTK_CONFIRM_ORDER_QUEUE", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TTK_CONFIRM_ORDER_QUEUE")
    public Long getId() {
        return id;
    }
