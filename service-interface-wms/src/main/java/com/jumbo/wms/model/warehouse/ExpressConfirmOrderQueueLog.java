...
@Entity
@Table(name = "T_EX_CONFIRM_ORDER_QUEUE_LOG")
public class ExpressConfirmOrderQueueLog extends BaseModel {

	private static final long serialVersionUID = 4384333594898915402L;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_EXPRESSCQQ", sequenceName = "S_EX_CONFIRM_ORDER_QUEUE_LOG", allocationSize = 1)
