 ...
 */
@Entity
@Table(name = "T_CONVERSE_YX_STOCKIN")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class ConverseYxStockin extends BaseModel {
    private static final long serialVersionUID = 4018550581581605366L;
    /*
     * PK
     */
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_CONVERSE_YX_STOCKIN", sequenceName = "S_T_CONVERSE_YX_STOCKIN", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_CONVERSE_YX_STOCKIN")
    public Long getId() {
        return id;
    }
