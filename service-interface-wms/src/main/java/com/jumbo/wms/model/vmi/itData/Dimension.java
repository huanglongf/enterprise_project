 ...
 */
@Entity
@Table(name = "T_IT_DIMENSION")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class Dimension extends BaseModel {
    /**
	 * 
	 */
    private static final long serialVersionUID = 8540750870489744448L;
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_DIMENSION", sequenceName = "S_IT_DIMENSION", allocationSize = 1)
