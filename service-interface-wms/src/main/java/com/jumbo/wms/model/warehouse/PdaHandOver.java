...
@Entity
@Table(name = "t_wh_pda_hand_Over")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION, dynamicUpdate = true)
public class PdaHandOver extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_PDA_HAND_OVER", sequenceName = "s_t_wh_pda_hand_Over", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_PDA_HAND_OVER")
    public Long getId() {
        return id;
    }
