 ...
 */
@Entity
@Table(name = "T_WH_QLG_STA_DELIVERY_INFO")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class QueueLogStaDeliveryInfo extends BaseModel {
    /**
	 * 
	 */
    private static final long serialVersionUID = 6898627447712582832L;
    /**
     * PK
     */
    private long id;
    ...
    @Column(name = "trans_memo", length = 100)
