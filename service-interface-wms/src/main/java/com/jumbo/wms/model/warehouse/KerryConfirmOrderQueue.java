...
@Entity
@Table(name = "T_KERRY_CONFIRM_ORDER_QUEUE")
public class KerryConfirmOrderQueue extends BaseModel {

    private static final long serialVersionUID = 4763965715618285942L;
    ...
    private Integer type;       // 类型 1:确认订单  2:取消订单
    
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_KERRYCQQ", sequenceName = "S_T_KERRY_CONFIRM_ORDER_QUEUE", allocationSize = 1)
