 ...
 */
@Entity
@Table(name = "T_CONVERSE_YX_RECEIVE")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class ConverseYxReceive extends BaseModel {
    private static final long serialVersionUID = -1004553111829821041L;
    /*
     * PK
     */
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_CONVERSE_YX_RECEIVE", sequenceName = "S_T_CONVERSE_YX_RECEIVE", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_CONVERSE_YX_RECEIVE")
    public Long getId() {
        return id;
    }
    ...
    @Column(name = "INSEAM_CODE", length = 30)
    ...
    @Column(name = "SAP_CARTON", length = 50)
