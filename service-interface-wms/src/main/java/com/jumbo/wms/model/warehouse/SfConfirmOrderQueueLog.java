 ...
 */
@Entity
@Table(name = "T_SF_CONFIRM_ORDER_QUEUE_LOG")
public class SfConfirmOrderQueueLog extends BaseModel {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_SFCQQ", sequenceName = "S_T_SF_CONFIRM_ORDER_QUEUE_LOG", allocationSize = 1)
