...
@Entity
@Table(name = "T_LEVISSHOES_RECEIVE")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class LevisShoesReceive  extends BaseModel{
    /**
     * 
     */
    private static final long serialVersionUID = -7779393006575189981L;
    /*
     * PK
     */
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_LEVISSHOES_RECEIVE", sequenceName = "S_T_LEVISSHOES_RECEIVE", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_LEVISSHOES_RECEIVE")
    public Long getId() {
        return id;
    }
