 ...
 */
@Entity
@Table(name = "T_IT_PLU_PRICE")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class PluPrice extends BaseModel {
    /**
	 * 
	 */
    private static final long serialVersionUID = -148551430929310122L;
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_IT_PLU_PRICE", sequenceName = "S_IT_PLU_PRICE", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IT_PLU_PRICE")
    public Long getId() {
        return id;
    }
