...
public class Plu extends BaseModel {
    /**
	 * 
	 */
    private static final long serialVersionUID = 5153634960389503531L;
    private Long id;
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_IT_PLU", sequenceName = "S_IT_PLU", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_IT_PLU")
    public Long getId() {
        return id;
    }
