...
@Entity
@Table(name = "T_ESPRIT_GIFT_ITEM")
@org.hibernate.annotations.Entity(optimisticLock = OptimisticLockType.VERSION)
public class ESPGiftItem extends BaseModel {
    ...
    private String epcCustomerOnly;


    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_ESPRIT_GIFT_ITEM", sequenceName = "S_T_ESPRIT_GIFT_ITEM", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_ESPRIT_GIFT_ITEM")
    public Long getId() {
        return id;
    }
    ...
    @Column(name = "GIFTITEM_SEASONYEAR")
    ...
    @Column(name = "GIFTITEM_SEASONCODE")
    ...
    @Column(name = "GIFTITEM_EFFECTIVEDATE")
    ...
    @Column(name = "GIFTITEM_EXPIRYDATE")
    ...
    @Column(name = "GIFTITEM_EPCCUSTOMERONLY")
    public String getEpcCustomerOnly() {
        return epcCustomerOnly;
    }

    public void setEpcCustomerOnly(String epcCustomerOnly) {
        this.epcCustomerOnly = epcCustomerOnly;
    }
