...
public class OutboundCancelSaleOrderRequest {

    @XmlElement(name = "CompanyCode", required = true)
    protected String companyCode;
    @XmlElement(name = "SaleOrders", required = true)
    protected OutboundCancelReqSaleOrders saleOrders;
     ...
     * @return
     *     possible object is
     *     {@link OutboundCancelReqSaleOrders }
     *     
     */
    public OutboundCancelReqSaleOrders getSaleOrders() {
        return saleOrders;
    }
     ...
     *     
     */
    public void setSaleOrders(OutboundCancelReqSaleOrders value) {
