...
public class OutboundRtnSaleOrderOutboundDetailRequest {

    @XmlElement(name = "CompanyCode", required = true)
    protected String companyCode;
    @XmlElement(name = "SaleOrders", required = true)
    protected OutboundRtnReqSaleOrders saleOrders;
     ...
     * @return
     *     possible object is
     *     {@link OutboundRtnReqSaleOrders }
     *     
     */
    public OutboundRtnReqSaleOrders getSaleOrders() {
        return saleOrders;
    }
     ...
     *     
     */
    public void setSaleOrders(OutboundRtnReqSaleOrders value) {
