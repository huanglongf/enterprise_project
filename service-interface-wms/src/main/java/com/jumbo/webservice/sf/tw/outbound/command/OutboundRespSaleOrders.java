...
public class OutboundRespSaleOrders {

    @XmlElement(name = "SaleOrder", required = true)
    protected List<OutboundRespSaleOrder> saleOrder;
     ...
     * {@link OutboundRespSaleOrder }
     * 
     * 
     */
    public List<OutboundRespSaleOrder> getSaleOrder() {
        if (saleOrder == null) {
            saleOrder = new ArrayList<OutboundRespSaleOrder>();
        }
