...
public class OutboundRtnReqSaleOrders {

    @XmlElement(name = "SaleOrder", required = true)
    protected List<OutboundRtnReqSaleOrder> saleOrder;
     ...
     * {@link OutboundRtnReqSaleOrder }
     * 
     * 
     */
    public List<OutboundRtnReqSaleOrder> getSaleOrder() {
        if (saleOrder == null) {
            saleOrder = new ArrayList<OutboundRtnReqSaleOrder>();
        }
