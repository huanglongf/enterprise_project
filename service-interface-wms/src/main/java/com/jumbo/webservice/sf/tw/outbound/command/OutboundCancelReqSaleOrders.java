...
public class OutboundCancelReqSaleOrders {

    @XmlElement(name = "SaleOrder", required = true)
    protected List<OutboundCancelReqSaleOrder> saleOrder;
     ...
     * {@link OutboundCancelReqSaleOrder }
     * 
     * 
     */
    public List<OutboundCancelReqSaleOrder> getSaleOrder() {
        if (saleOrder == null) {
            saleOrder = new ArrayList<OutboundCancelReqSaleOrder>();
        }
