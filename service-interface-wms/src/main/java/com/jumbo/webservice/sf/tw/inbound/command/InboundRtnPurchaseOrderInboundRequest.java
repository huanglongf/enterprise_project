...
public class InboundRtnPurchaseOrderInboundRequest {

    @XmlElement(name = "CompanyCode", required = true)
    protected String companyCode;
    @XmlElement(name = "PurchaseOrders", required = true)
    protected InboundRtnReqPurchaseOrders purchaseOrders;
     ...
     * @return
     *     possible object is
     *     {@link InboundRtnReqPurchaseOrders }
     *     
     */
    public InboundRtnReqPurchaseOrders getPurchaseOrders() {
     ...
     *     
     */
    public void setPurchaseOrders(InboundRtnReqPurchaseOrders value) {
