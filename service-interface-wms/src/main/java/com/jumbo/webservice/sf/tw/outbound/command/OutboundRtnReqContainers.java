...
public class OutboundRtnReqContainers {

    @XmlElement(name = "Container", required = true)
    protected List<OutboundRtnReqContainer> container;
     ...
     * {@link OutboundRtnReqContainer }
     * 
     * 
     */
    public List<OutboundRtnReqContainer> getContainer() {
        if (container == null) {
            container = new ArrayList<OutboundRtnReqContainer>();
        }
