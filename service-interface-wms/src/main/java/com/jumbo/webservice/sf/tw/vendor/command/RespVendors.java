 ...
 *       &lt;sequence>
 *         &lt;element ref="{}Vendor" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RespVendors {

    @XmlElement(name = "Vendor", required = true)
    protected List<RespVendor> vendor;
     ...
     * 
     */
    public List<RespVendor> getVendor() {
        if (vendor == null) {
            vendor = new ArrayList<RespVendor>();
        }
        return this.vendor;
    }
