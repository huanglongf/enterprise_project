...
public class OutboundCancelRespSaleOrders {

    @XmlElement(name = "SaleOrder", required = true)
    protected List<OutboundCancelRespSaleOrder> saleOrder;
     ...
     * {@link OutboundCancelRespSaleOrder }
     * 
     * 
     */
    public List<OutboundCancelRespSaleOrder> getSaleOrder() {
        if (saleOrder == null) {
            saleOrder = new ArrayList<OutboundCancelRespSaleOrder>();
        }
