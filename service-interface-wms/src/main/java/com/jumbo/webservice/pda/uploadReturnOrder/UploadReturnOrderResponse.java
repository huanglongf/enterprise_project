...
/**
 * <p>
 * uploadReturnOrderResponse complex type的 Java 类。
 * 
 * <p>
 * 以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="uploadReturnOrderResponse">
 *   &lt;complexContent>
...
@XmlType(name = "uploadReturnOrderResponse", propOrder = {"authResponseHeader", "baseResponseBody"})
public class UploadReturnOrderResponse implements AuthResponse, Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 2542254916353072380L;
