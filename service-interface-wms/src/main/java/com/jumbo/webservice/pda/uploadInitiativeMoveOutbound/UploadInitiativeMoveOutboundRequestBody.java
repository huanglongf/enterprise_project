...
/**
 * <p>
 * Java class for uploadInitiativeMoveOutboundRequestBody complex type.
 * 
 * <p>
...
@XmlType(name = "uploadInitiativeMoveOutboundRequestBody", propOrder = {"slipCode", "uniqCode", "userName", "outbound"})
public class UploadInitiativeMoveOutboundRequestBody implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 6009681801088621314L;
