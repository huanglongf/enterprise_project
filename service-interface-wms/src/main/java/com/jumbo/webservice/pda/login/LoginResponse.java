...
@XmlType(name = "loginResponse", propOrder = {"authResponseHeader", "baseResponseBody"})
public class LoginResponse implements AuthResponse, Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -705918837560071997L;
