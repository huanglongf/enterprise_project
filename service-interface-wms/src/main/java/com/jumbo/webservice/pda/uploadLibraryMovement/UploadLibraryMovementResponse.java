...
/**
 * <p>
 * uploadLibraryMovementResponse complex type的 Java 类。
 * 
 * <p>
 * 以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="uploadLibraryMovementResponse">
 *   &lt;complexContent>
...
@XmlType(name = "uploadLibraryMovementResponse", propOrder = {"authResponseHeader", "baseResponseBody"})
public class UploadLibraryMovementResponse implements AuthResponse, Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -4945510033134080365L;
