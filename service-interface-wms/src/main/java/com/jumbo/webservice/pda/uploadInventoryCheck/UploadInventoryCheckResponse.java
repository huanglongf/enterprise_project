...
/**
 * <p>
 * uploadInventoryCheckResponse complex type的 Java 类。
 * 
 * <p>
 * 以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="uploadInventoryCheckResponse">
 *   &lt;complexContent>
...
@XmlType(name = "uploadInventoryCheckResponse", propOrder = {"authResponseHeader", "baseResponseBody"})
public class UploadInventoryCheckResponse implements AuthResponse, Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 7757565658048733176L;
