...
/**
 * <p>
 * getInboundDataResponseBody complex type的 Java 类。
 * 
 * <p>
 * 以下模式片段指定包含在此类中的预期内容。
 * 
...
@XmlType(name = "getInboundDataResponseBody", propOrder = {"status", "code", "slipCode", "uniqCode", "skus"})
public class GetInboundDataResponseBody implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -1755609305514992356L;
