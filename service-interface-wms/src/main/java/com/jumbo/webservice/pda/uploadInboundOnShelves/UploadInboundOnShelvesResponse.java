...
/**
 * <p>
 * uploadInboundOnShelvesResponse complex type的 Java 类。
 * 
 * <p>
 * 以下模式片段指定包含在此类中的预期内容。
 * 
...
@XmlType(name = "uploadInboundOnShelvesResponse", propOrder = {"authResponseHeader", "baseResponseBody"})
public class UploadInboundOnShelvesResponse implements AuthResponse, Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -7366471732018297429L;
