...
/**
 * <p>
 * uploadPickingOutboundResponse complex type的 Java 类。
 * 
 * <p>
 * 以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="uploadPickingOutboundResponse">
 *   &lt;complexContent>
...
@XmlType(name = "uploadPickingOutboundResponse", propOrder = {"authResponseHeader", "baseResponseBody"})
public class UploadPickingOutboundResponse implements AuthResponse, Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -4241529578017942463L;
