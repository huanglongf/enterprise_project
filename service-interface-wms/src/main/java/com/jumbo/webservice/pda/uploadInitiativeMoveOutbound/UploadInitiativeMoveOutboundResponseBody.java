...
/**
 * <p>
 * Java class for uploadInitiativeMoveOutboundResponseBody complex type.
 * 
 * <p>
...
@XmlType(name = "uploadInitiativeMoveOutboundResponseBody", propOrder = {"code", "slipCode", "uniqCode", "baseResponseBody"})
public class UploadInitiativeMoveOutboundResponseBody implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -3949430909449113269L;
