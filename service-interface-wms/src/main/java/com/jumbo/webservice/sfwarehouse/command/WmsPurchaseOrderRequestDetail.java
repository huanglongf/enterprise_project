...
public class WmsPurchaseOrderRequestDetail implements Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = 4676499991922534967L;
    @XmlElement
    ...
    public void setTotal_qty(BigDecimal totalQty) {
        total_qty = totalQty;
    }
