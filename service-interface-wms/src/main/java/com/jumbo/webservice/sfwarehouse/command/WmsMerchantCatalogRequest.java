...
@XmlRootElement(name = "wmsMerchantCatalogRequest")
public class WmsMerchantCatalogRequest implements Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = -8908298900978344954L;
    @XmlElement
    ...
    @XmlElement
    private BigDecimal coversion_qty_1;// <conversion_qty_1>数量单位1转换比例</conversion_qty_1>
    @XmlElement
    ...
    @XmlElement
    private String dimension_um_1;// <dimension_um_1>尺寸单位1</dimension_um_1>
    @XmlElement
    ...
    @XmlElement
    private String dimension_um_2;// <dimension_um_2>尺寸单位2</dimension_um_2>
    @XmlElement
    ...
    @XmlElement
    private String quantity_um_3;// <quantity_um_3>货品数量单位2</quantity_um_3>
    @XmlElement
    private String weight_um_3;// <weight_um_3>重量单位2</weight_um_3>
    @XmlElement
    private String dimension_um_3;// <dimension_um_3>尺寸单位2</dimension_um_3>
    @XmlElement
    private String treat_as_loose_3;// <treat_as_loose_3>包装单位2视为零头</treat_as_loose_3>
    @XmlElement
    ...
    @XmlElement
    private String quantity_um_4;// <quantity_um_4>货品数量单位2</quantity_um_4>
    @XmlElement
    private String weight_um_4;// <weight_um_4>重量单位2</weight_um_4>
    @XmlElement
    private String dimension_um_4;// <dimension_um_4>尺寸单位2</dimension_um_4>
    @XmlElement
    private String treat_as_loose_4;// <treat_as_loose_4>包装单位2视为零头</treat_as_loose_4>
    @XmlElement
    ...
    public BigDecimal getCoversion_qty_1() {
        return coversion_qty_1;
    }

    public void setCoversion_qty_1(BigDecimal coversionQty_1) {
        coversion_qty_1 = coversionQty_1;
    }
