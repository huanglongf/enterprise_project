...
<html>
	<head lang="en">
		...
		<script type='text/javascript'>
			...
			$(document).ready(function() {
				 //document.getElementById("cost_center").style.width ="200px";
				...
				$('#expressCode').bind('change',function(){
					ExpressCodeChange("expressCode","producttype_name","pay_path");
				...
				$('#pay_path').bind('change',function(){
					...
					if(pay_path=="" ||pay_path==null ||pay_path==undefined){
						$("#span_pay_path").show();
					}else if(pay_path!="" ||pay_path!=null ||pay_path!=undefined){
						$("#span_pay_path").hide();
					}
					if(pay_path==4){
			...
			setStyleamount();
		 	...
		 	$(function(){ 
			      ...
			      $("#cost_center").next().attr("disabled", "disabled");
			      $("#pay_path").next().attr("disabled", "disabled");
			      $("#span_cost_center").hide();
			}); 
			...
			/* 	var to_orgnization=document.getElementById("to_orgnization").value; */
				...
				var pay_path=document.getElementById("pay_path").value;
				var cost_center=document.getElementById("cost_center").value;
				var amount_flag=document.getElementById("amount_flag").value;
				...
				$.ajax({
					type: "POST",
				  	url: "${root}control/orderPlatform/waybillMasterController/baozunadd.do?"+param,
					dataType: "json",
	...
	<body>
		<div class="page-header">
			<h1 style='margin-left: 20px'>新增宝尊运单</h1>
		</div>
			...
			<form id="addForm">
				<table> 
			   		<tr>
		  				...
		  				<td width="170px" align="left">
			  				<select id="amount_flag" name="amount_flag" data-edit-select="1" style="width: 168px;">
			  			...
			  			<td  align="left">
			  				<input type='text' id='insured' name='insured' style="width: 160px;">
			  			</td>
		  				<td></td>
		  			</tr>
		  		<tr>
		  		...
		  		<tr>
	  				...
	  				<td width="170px" align="left">
	  					<%--<c:if test="${org.id==165|| org.id==166||org.id==727||org.id==997}"> --%>
	  					<c:if test="${org.id==165|| org.id==166||org.id==727}">
						...
						<c:if test="${org.id==176|| org.id==177|| org.id==178|| org.id==999 }">
		  				<select id="pay_path" name="pay_path" data-edit-select="1" style="width: 168px;">
		  					<option value= "">---请选择---</option>
						...
						<c:if test="${org.id!=176&& org.id!=177&& org.id!=178&& org.id!=165&& org.id!=166&& org.id!=727&& org.id!=999}">
		  				<select id="pay_path" name="pay_path" data-edit-select="1" style="width: 168px;">
			  				<option value= "">---请选择---</option>
		  				 	<c:forEach items= "${pay_path}" var= "street" >
		  					    <option value="${street.pay_path}"  >${street.pay_ame}</option>
	  				...
	  				<select id="cost_center" name="cost_center"   data-edit-select-baozun="1"  style="width: 160px;">
		  				<option value= "">---请选择---</option>
		  		...
		  		<tr>
		  			...
		  			<td align="left">
		  				<input type='text' id='from_contacts' name='from_contacts' onblur="onclkfrom_contacts(this)" value="" style="width: 160px;"><span style="color:red;">*</span><!-- ${org.org_contacts} -->
		  			</td>
		  			<td>
		  			...
		  			<td align="left">
		  				<input type='text' id='from_phone' onkeyup="value=value.replace(/[^\* \- \d.]/g,'')" onblur="onclkfrom_phone(this)" name='from_phone' value="${org.org_phone}" style="width: 160px;"><span id='span_from_phone' style="color:red;">*</span>
		  			</td>
		  			<td></td>
		  			<td></td><td></td><td></td>
		  		</tr>
		  		...
		  		<tr>
		  			...
		  			<td align="left" colspan="8">
		  				<input type='text' id='from_address' style="width: 877px;" name='from_address'onblur="onclkfrom_address(this)" value="${org.org_address}" ><span  id='span_from_address' style="color:red;">*</span>
		  			</td>
		  			<!-- <td></td>
		  			<td></td>
		  			<td></td> -->
		  		...
		  		<tr>
		  			...
		  			<td  align="left">
		  				<input type='text' onkeyup="value=value.replace(/[^\* \- \d.]/g,'')" onblur="onclkto_phone(this)" id='to_phone' name='to_phone' value="${queryOrg.org_phone}" style="width: 160px;"><span id="span_to_phone" style="color:red;">*</span>
		  			</td>
		  			<td></td>
		  			<td></td>
		  			<td></td>
		  		...
		  		<tr> 
		  			...
		  			<td  align="left" colspan="8">
		  				<input type='text' id='to_address' name='to_address'  style="width: 877px;"  onblur="onclkto_address(this)" value="${queryOrg.org_address}" ><span class="span_to_address" style="color:red;">*</span>
		  			</td>
		  		</tr>
			</table>
			</form>
				...
				<div border="1" bordercolor="#a0c6e5" style="border-collapse:collapse;"  class="31sd">
