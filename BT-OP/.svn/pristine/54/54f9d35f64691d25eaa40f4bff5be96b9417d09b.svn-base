...
<html>
	...
	<body>
		<div class="page-header">
			<h1 style='margin-left: 20px'>用户角色设置</h1>
		</div>
		<!-- 新增页面 -->
		<div style="margin-top: 20px;margin-left: 20px;margin-bottom: 20px;">
			<form id="addForm">
				<table> 
			   		...
			   		<tr>
		  				<td width="160px" align="left"><label style="width: 95px;">角色</label></td>
		  				<td width="170px" align="left">
		  					<input type='text' id='role_id' name='role_id'     style="width: 160px;">
		  				</td>
		  			</tr>
			</table>
			</form>
