			...
			function addLogistics(){
				...
				$.ajax({
					...
					success: function (data) {  
					    if(data.data==0){
		   	            	alert("操作成功！");
		   	            	loadingCenterPanel('${root }/control/orderPlatform/waybillMasterController/initail.do');
		   	            }else if(data.data!=0){
		   	            	alert("操作失败！");
		   	            	alert(data.msg);
		   	             }
			...
			<form id="addForm">
				<table> 
			   		<tr>
			  			...
			  			<td  align="left">
			  				<select id="payment" name="payment" data-edit-select="1" style="width: 168px;">
				  				<option value= "月付">月付</option>
							</select>
			  			</td>
			  			<td></td>
			  			<td align="left"><label style="width: 70px;">是否保价</label></td>
			  			<td  align="left">
		  		...
		  		<tr> 
		  			...
		  			<td  align="left" colspan="8">
		  				<input type='text' id='to_address' name='to_address' style="width: 750px;"  onblur="onclkto_address(this)" value="${queryOrg.org_address}" ><span class="span_to_address" style="color:red;">*</span>
		  			</td>
	  				...
	  				<td  align="left" colspan="5"><label style="width: 70px;">收货地址</label></td>
		  			<td></td>--%>
		  		</tr>
		  		<tr>
		  			<td  align="left" colspan="5"><label style="width: 70px;">收货信息</label></td>
