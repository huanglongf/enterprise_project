...
/* 		function deleteRow(){
		...
		function onchecks(){
		      ...
		      /* td3.innerHTML="<input type='text' style='width: 100px;' name='sku_code' id='"+sku_code+"' class='fulltext required' />";
		       var td4 = tr1.insertCell();
		      td4.innerHTML="<input type='text' style='width: 100px;' name='sku_name' id='"+sku_name+"' class='fulltext required' />";
		       var td5 = tr1.insertCell();
		       td5.innerHTML="<input type='text' style='width: 100px;' onafterpaste='value=value.replace(/\D/g,'')' name='qty' id='"+qty+"' class='fulltext required' onblur='setStyleqty()'/>";
		       var td6 = tr1.insertCell();
		      td6.innerHTML="<input type='text' style='width: 100px;' onkeyup='value=value.replace(/[^\d\.]/g,'')' name='weight' id='"+weight+"' class='fulltext required' onblur='setStyleweight()'/>";
		      var td7 = tr1.insertCell();
		      td7.innerHTML="<input type='text' style='width: 100px;' onkeyup='value=value.replace(/[^\d\.]/g,'')' name='volumn' id='"+volumn+"' class='fulltext required' onblur='setStylevolumn()'/>";
		      var td8 = tr1.insertCell();
		      td8.innerHTML="<input type='text' style='width: 100px;' onkeyup='value=value.replace(/[^\d\.]/g,'')' name='amount' id='"+amount+"' class='fulltext' onblur='setStyleamount()'/>";
		...
		function setStyleqty()
		{
			var tb = document.getElementById("tableId"); //根据id找到这个表格
			 ...
			 { 
			 	 var cell3 =  document.getElementById("qty"+i).value;
			 	sum = sum*1 +cell3*1;
			 }
		...
		function setStyleweight()
		{
			var tb = document.getElementById("tableId"); //根据id找到这个表格
			 ...
			 for(var i=1;i<rows.length;i++)//循环遍历所有的tr行 
			 { 
			 	 var cell3 =  document.getElementById("weight"+i).value;
			 	sum = sum*1 +cell3*1;
			 }
			document.getElementById("total_weight").value = sum*1;
		}
		function setStylevolumn()
		{
			var tb = document.getElementById("tableId"); //根据id找到这个表格
			 ...
			 for(var i=1;i<rows.length;i++)//循环遍历所有的tr行 
			 { 
			 	 var cell3 =  document.getElementById("volumn"+i).value;
			 	sum = sum*1 +cell3*1;
			 }
			document.getElementById("total_volumn").value = sum*1;
		}
		function setStyleamount()
		{
			var tb = document.getElementById("tableId"); //根据id找到这个表格
			 ...
			 for(var i=1;i<rows.length;i++)//循环遍历所有的tr行 
			 { 
			 	 var cell3 =  document.getElementById("amount"+i).value;
			 	sum = sum*1 +cell3*1;
			 }
			document.getElementById("total_amount").value = sum*1;
		} */
		...
		function slideDown(){
		 ...
		 $(function(){ 
		      $("#provice_code").next().attr("disabled", "disabled");
		      $("#city_code").next().attr("disabled", "disabled");
		      $("#state_code").next().attr("disabled", "disabled");
		}); 
	</script>
	</head>
	<body>
	<div class="page-header">
		<h1 style='margin-left: 20px'>修改运单</h1>
	</div>
		 ...
		 <form id="updateForm">			
			<table > 
			   <tr> 
		  			...
		  			<td width="170px" align="left" >
 						<select id="status" name="status" data-edit-select="1" style="width: 168px; " disabled="true">
			  					 <c:if test="${queryParam.status=='1'}"> 
									<option selected='selected' value="1">已录单</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='0'}"> 
									<option selected='selected' value="0">已作废</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='2'}"> 
									<option selected='selected' value="2">待揽收</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='4'}"> 
									<option selected='selected' value="2">已下单</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='5'}"> 
									<option selected='selected' value="2">已揽收</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='6'}"> 
									<option selected='selected' value="2">已发运</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='7'}"> 
									<option selected='selected' value="2">已签收</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='8'}"> 
									<option selected='selected' value="2">签收失败</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='9'}"> 
									<option selected='selected' value="2">已退回</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='10'}"> 
									<option selected='selected' value="2">已取消</option>
								 </c:if>
			  					 <c:if test="${queryParam.status=='11'}"> 
									<option selected='selected' value="2">下单失败</option>
								 </c:if>
						</select>
		  			</td>
		  			<td width="60px"></td>
		  			...
		  			<td width="170px" align="left">
		  				<input type='text' id='customer_number' name='customer_number' style="width: 160px;" value="${queryParam.customer_number}">
		  			</td>
		  			<td ></td>
		  		</tr>
		  		<tr>
		  			...
		  			<td ><span id="span_expressCode" style="color:red;"> *</span></td>
		  			...
		  			<td ><span id="span_producttype_name" style="color:red;"> *</span></td>
		  			<td  align="left"><label style="width: 95px;">快递单号</label></td>
		  			<td  align="left">
		  				<input type='text' id='waybill' name='waybill' style="width: 160px;" value="${queryParam.waybill}">
		  			</td>
		  			<td ></td>
		  		</tr>
		  		...
		  		<tr>
		  			...
		  			<td  align="left">
		  				<select id="group_code" name="payment" data-edit-select="1" style="width: 168px;" value="${queryParam.payment}">
		  			...
		  			<td align="left">
		  				<input type='text' id='sendcode' onblur="onclk_sendcode(this)" value="${queryParam.sendcode}" name='sendcode' style="width: 160px;">
		  			</td>
		  		...
		  		<tr>
		  			...
		  			<td ><span id="span_org_provice_code" style="color:red;"> *</span></td>
		  			...
		  			<td ><span id="span_org_city_code" style="color:red;"> *</span></td>
		  			...
		  			<td ><span id="span_org_state_code" style="color:red;"> *</span></td>
		  		</tr>
		  		<tr>
		  			<td  align="left"><label style="width: 70px;">街道</label></td>
		  			<td  align="left">
		  				<input type='text' id='to_street' name='to_street' value="${queryParam.to_street}" style="width: 160px;">
		  			</td>
		  			<td></td>
		  			<td  align="left"><label style="width: 95px;">收货联系人</label></td>
		  			<td  align="left">
		  				<input type='text' id='to_contacts' name='to_contacts' onblur="onclk(this)" value="${queryParam.to_contacts}" style="width: 160px;">
		  			</td>
		  			<td><span id='span_to_contacts' style="color:red;"> *</span></td>
		  			<td  align="left"><label style="width: 95px;">收货联系电话</label></td>
		  			<td  align="left">
		  				<input type='text' id='to_phone' name='to_phone' onblur="onclkto_phone(this)" onkeyup="value=value.replace(/[^\* \- \d.]/g,'')" value="${queryParam.to_phone}" style="width: 160px;">
		  			</td>
		  		...
		  		<tr> 
		  			...
		  			<td  align="left" colspan="4">
		  				<input type='text' id='to_address' name='to_address' onblur="onclkto_address(this)" value="${queryParam.to_address}" style="width: 550px;">
		  			</td>
		  			<td><span id="span_to_address" style="color:red;"> *</span></td>
		  			<td  align="right">
		  		...
		  		<tr>
		  			...
		  			<td><span id="span_provice_code" style="color:red;"> *</span></td>
		  			<td  align="left"><label style="width: 95px;" >市</label></td>
		  			<td  align="left">
		  			...
		  			<td><span id="span_city_code" style="color:red;"> *</span></td>
		  			<td  align="left"><label style="width: 95px;" >区</label></td>
		  			<td  align="left">
		  			...
		  			<td><span id="span_state_code" style="color:red;"> *</span></td>
		  		</tr>
		  		<tr>
		  			<td  align="left"><label style="width: 70px;">街道</label></td>
		  			<td  align="left">
			  				<input type='text' id='from_street' disabled="true" name='from_street' value="${queryParam.from_street}" style="width: 160px;">
		  			</td>
		  			<td></td>
		  			<td  align="left"><label style="width: 95px;">发货联系人</label></td>
		  			<td  align="left">
		  				<input type='text' id='from_contacts' disabled="true" name='from_contacts' onblur="onclkfrom_contacts(this)" value="${queryParam.from_contacts}" style="width: 160px;">
		  			</td>
		  			<td><span id="span_from_contacts" style="color:red;"> *</span></td>
		  			<td  align="left"><label style="width: 95px;">发货联系电话</label></td>
		  			<td  align="left">
		  				<input type='text' id='from_phone' disabled="true" name='from_phone' onblur="onclkfrom_phone(this)" onkeyup="value=value.replace(/[^\* \- \d.]/g,'')" value="${queryParam.from_phone}" style="width: 160px;">
		  			</td>
		  			<td><span id='span_from_phone' style="color:red;">*</span></td>
		  		</tr>
		  		<tr>
		  			<td  align="left"><label style="width: 70px;">发货地址</label></td>
		  			<td  align="left" style="width: 560px;"  colspan="6">
		  				<input type='text' id='from_address' disabled="true" name='from_address' onblur="onclkfrom_address(this)" style="width: 550px;" value="${queryParam.from_address}" style="width: 160px;"><span  id='span_from_address' style="color:red;">      *</span>
		  			</td>
		  			<td></td>
		  			<td></td>
		  			<td></td>
