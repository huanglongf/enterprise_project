...
/** PTF打印与iReport对应的字段名
	* @Description: 
	* @author  Hanery:
 	* @date 2017年11月22日 下午1:24:38  
*/
public class SFExpressPrint implements Serializable{
	...
	public String getExpectedFromDate() {
		return expectedFromDate;
	}
	public void setExpectedFromDate(String expectedFromDate) {
		this.expectedFromDate = expectedFromDate;
	}
