package com.bt.orderPlatform.reflected.utils;
...
* @Description: TODO(页面解析器) 
* @author Yuriy.Jiang
* @date 2016年6月22日 上午11:18:11 
*  
*/
public class CommonPageParser {
	...
	static{
		try{
			//windows 获取文件模板根路径
			//String  templateBasePath = getRootPath()+"\\src\\template" ;
			//Mac 获取文件模板根路径
			String  templateBasePath = getRootPath()+"/src/template" ;
