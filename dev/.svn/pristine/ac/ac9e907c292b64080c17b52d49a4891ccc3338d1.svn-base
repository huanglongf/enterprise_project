...
public class WareImportErrorQueryParam extends QueryParameter{
    /**
	 * 
	 */
    ...
    public String getStoreCostCenter() {
        return storeCostCenter;
    }

    public void setStoreCostCenter(String storeCostCenter) {
        this.storeCostCenter = storeCostCenter == null ? null : storeCostCenter.trim();
    }
    ...
    public void setDisFlag(String disFlag) {
        this.disFlag = disFlag == null ? null : disFlag.trim();
    }
