...
public class ReceiveDeadlineQueryParam extends QueryParameter {
	...
	public Date getEmbrace_time() {
		return embrace_time;
	}
	public void setEmbrace_time(Date embrace_time) {
