...
/** 
 * @ClassName: RedisPool1
 * @Description: TODO(redis连接1)
 * @author Ian.Huang
 * @date 2017年11月16日 下午2:37:27 
 * 
 */
@Component("redisPool1")
public class RedisPool1 extends RedisPool implements RedisPoolHelper {
	
	private static final Logger logger = Logger.getLogger(RedisPool1.class);
