...
public class YtoTemplateQueryParam extends QueryParameter {
	
	
	private Integer id;			//
	private String transport_time;			//发货日期
	private String express_number;			//运单号
	private String origin;			//始发地
	private String province_dest;			//目的省
	private String city_dist;			//市区
	private String weight;			//实际重量
	private String charge_weight;			//圆通计费重量
	private String firstWeightPrice;			//首重报价
