...
<html>
	<head lang="en">
	    ...
	    <script type="text/javascript" src="<%=basePath %>assets/js/jquery.ztree.core.js"></script>
	    <script type="text/javascript" src="<%=basePath %>assets/js/jquery.ztree.excheck.js"></script>
	    <script type="text/javascript" src="<%=basePath %>assets/js/jquery.ztree.exedit.js"></script>
