...
public class SessionFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
		// 不过滤的uri
		String[] notFilter = new String[] { "login.jsp","main.jsp","1.jsp","2.jsp","3.jsp","4.jsp",
				"/BT-WMS/control/userController/login.do",
				"manage_list.do",
				"a.do",
				"a_dtl.do",
				"b.do",
				"c.do",
				"d.do",
				"close_c.do","export_a.do","export_d.do","export_b.do","export_e.do"};
