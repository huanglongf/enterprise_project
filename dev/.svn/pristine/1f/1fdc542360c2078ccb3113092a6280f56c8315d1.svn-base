...
<script type="text/javascript">
	function lower_next(){
        ...
        if(!reg.test(container_code)){
        	$("#msg").html("容器号格式有误!");
        	$("#container_code").attr("disabled",false);
        	$("#container_code").val("");
		...
		if(container_code.length>20){
			...
			window.location.href="${root}control/mainController/setContainer.do?opertion_type="+$("#opertion_type").val()+"&container_code="+container_code;
		}
	};
...
<body>
	<div align="center">
		<table style="width: 280px;">
			<tr>
				<td width="40%"><span style="font-size: 13px;">WMS|下架(逐件)</span><div id="play-frame-2"></div></td>
