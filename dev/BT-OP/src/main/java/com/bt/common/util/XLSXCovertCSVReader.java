...
public class XLSXCovertCSVReader {
		...
		public void endElement(String uri, String localName, String name) throws SAXException {
			...
			if ("v".equals(name)) {
				...
				if(thisColumn<minColumns){
					record[thisColumn] = thisStr.replace("\"","").replace("\n", "").replace(",", " ");	
				}
				// Update column
				if (thisColumn > -1)
				...
				if (minColumns > 0) {
					...
					if (record[0] != null||record[1] != null||record[2] != null||record[3] != null||record[4] != null||record[5] != null||record[6] != null||record[7] != null||record[8] != null){
						// 判断是否空行
	...
	public static void main(String[] args) throws Exception {  
        List<String[]> list = XLSXCovertCSVReader.readerExcel("/usr/local/log/时效信息导入模板.xlsx",null, 16);
		for (String[] row : list) {
