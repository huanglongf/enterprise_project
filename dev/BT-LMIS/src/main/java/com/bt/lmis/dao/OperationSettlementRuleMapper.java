...
/**
* @ClassName: OperationSettlementRuleMapper
* @Description: TODO(OperationSettlementRuleMapper)
* @author Yuriy.Jiang
*
* @param <T>
*/ 
public interface OperationSettlementRuleMapper<T> extends BaseMapper<T> {
