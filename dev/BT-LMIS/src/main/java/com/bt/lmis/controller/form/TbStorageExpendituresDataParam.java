...
public class TbStorageExpendituresDataParam extends QueryParameter {
    ...
    private java.math.BigDecimal storage_acreage;
    private String acreage_unit;
