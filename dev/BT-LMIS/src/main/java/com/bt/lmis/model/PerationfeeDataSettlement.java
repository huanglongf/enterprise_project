...
/**
* @ClassName: PerationfeeDataSettlement
* @Description: TODO(PerationfeeDataSettlement)
* @author Yuriy.Jiang
* @date 2016年6月22日 上午10:19:25
*
*/
public class PerationfeeDataSettlement {
	...
	public String getGd_qty_unit() {
		return gd_qty_unit;
	}
	public void setGd_qty_unit(String gd_qty_unit) {
		this.gd_qty_unit = gd_qty_unit;
	}
