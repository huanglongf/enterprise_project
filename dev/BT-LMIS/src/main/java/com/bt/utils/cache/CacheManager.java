 ...
 * @Description: TODO(简易本地缓存的实现类)
 * @author Ian.Huang
 * @date 2017年4月26日 下午2:11:29 
 * 
 */
public class CacheManager {
	...
	// 使用默认容量创建一个Map  
	private static ConcurrentHashMap<String, Cache> cache = new ConcurrentHashMap<String, Cache>(DEFAULT_CAPACITY);
	...
	private static boolean putCloneValue(String key, Object value, int expireTime) {  
		try {
			...
			// 序列化赋值 
			Cache entityClone = clone(new Cache(value, System.nanoTime(), expireTime));  
