...
public class AgeingDetailBackupsQueryParam extends QueryParameter{
    private Integer id;
...
private Date createTime;
    ...
    public  AgeingDetailBackupsQueryParam(String[] row) {
		...
		if(row[7]!=null){
			if(row[7].matches("[0-9]*")){
				...
				this.ageingValue =null;
			}
		}
		
    }
    public  AgeingDetailBackupsQueryParam(){
