...
function czuaa(){
    var b=document.getElementById("czuContent").scrollLeft;
    document.getElementById("czutitle").scrollLeft=b;
  }
function pageJump() {
	query_zc_unsettlement(1);
}
</script>
<div id="carrier_zc_unsettlement">
	<button class="btn btn-xs btn-yellow" onclick="query_zc_unsettlement(0)">
								查询
	</button>
	<button id="imps" name="imps" class="btn btn-xs btn-yellow" onclick="exportZCYFExcel('unsett')">
								<i class="icon-hdd"></i>导出
	</button>
	<div class="title_div" id="czutitle">
	...
	<div style="height:400px; overflow:auto; overflow:scroll; border:solid #F2F2F2 1px;" id="czuContent" onscroll="czuaa()">
