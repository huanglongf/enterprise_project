		...
		<form id= "main_search">
			<table >
		  		<tr>
		  			...
		  			<td width="20%" align="left">
		  			  <input id="sku_code" name="sku_code"  style='width:100%;height:34px' >
					</input>
		  			</td>
		  		</tr>

		  		<tr align="center">
		  		<td width="10%" align="right" ><label>时间(开始):</label></td>
		  			<td width="20%" align="left">
		  			 <div style="width:100%;" >
		                 <input id= "begin_start_time" name= "begin_start_time" type="text" id="d412" style= "width:100%; height: 34px;" class= "Wdate" placeholder= "" onfocus= "WdatePicker({dateFmt:'yyyy-MM-dd'})" />
			         </div>		
		  		</td>
		  		<td width="10%" align="right" ><label>时间(结束):</label></td>
		  			<td width="20%" align="left">
		  			 <div style="width:100%;" >
		                 <input id= "end_start_time" name= "end_start_time" type="text" id="d412" style= "width:100%; height: 34px;" class= "Wdate" placeholder= "" onfocus= "WdatePicker({dateFmt:'yyyy-MM-dd'})" />
			         </div>		
		  		</td>
		  		</tr>
			</table>
	...
	<script type="text/javascript">
		...
		function pageJump() {
			...
			loadingStyle();
		 	...
		 	$.ajax({
					type: "POST",
		           	url:'${root}/control/storageExpendituresController/page.do?'+param,
		           	dataType: "text",
		           	data:'',
		    		cache:false,
		...
		function download(){
			$(window).scrollTop(0);
			if($("#begin_start_time").val()==''||$("#end_start_time").val()=='')
				{alert('导出时间不能为空！');return;}
			param=$('#main_search').serialize();
			var begin=$("#begin_start_time").val()+" 00:00:00";
			var end =$("#end_start_time").val()+" 00:00:00";
			...
			$.ajax({
				type: "POST",
	           	url:'${root}/control/storageExpendituresController/download.do?'+param,
	           	dataType: "json",
	           	data:'',
	           	success: function (data){
	           	 cancelLoadingStyle();
