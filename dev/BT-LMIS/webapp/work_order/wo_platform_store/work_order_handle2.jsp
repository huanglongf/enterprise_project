...
<html>
	<head lang="en">
		...
		<script type="text/javascript">
			$(function() {
				...
				var relatedWoNo = $("#relatedWoNo_label2").text();
				...
				$("#relatedWoNo_label2").text(str);
			})
			function synchronizeHeight() {
				$("#timeline2").height($(".pinal-left").height() - 36);
				$(".tab-pane").height($("#timeline2").height());
			}
		</script>
		<style>
			table.filetables {
	...
	<body>
		<div class="col-md-12">
			<input type="hidden" id="woId2" name="woId" value="${workOrderStore.id }" data-version="${workOrderStore.version }" />
			<div class="col-md-6 container pinal-left">
				...
				<div class="row form-group">
					...
					<label class="col-md-6 no-padding no-margin" id="relatedWoNo_label2">${workOrderStore.relatedWoNo }</label>
				</div>
				<div class="row form-group">
			...
			<div class="col-md-6 pinal-right">
				<ul class="nav nav-tabs tab-color-blue" role="tablist">
					<li role="presentation" class="active"><a href="#first_tab2" role="tab" data-toggle="tab">处理记录</a></li>
					<li role="presentation"><a href="#third_tab2" role="tab" data-toggle="tab">订单列表</a></li>
					<li role="presentation" ${split_list_show ? "" : "style='display:none;'" }><a href="#second_tab2" role="tab" data-toggle="tab">拆分列表</a></li>
				</ul>
				<div class="tab-content no-padding">
					<div role="tabpanel" class="tab-pane active" id="first_tab2">
						<iframe id="timeline2" src="${root }control/workOrderPlatformStoreController/toTimeLine.do?woId=${workOrderStore.id }&readonly=1" style="border:0px;padding:0px;width:100%;overflow: visible;"></iframe>
					</div>
					<div role="tabpanel" class="tab-pane" id="third_tab2">
						<div id="third_tab_body2" style="border:0px;padding:0px;width:100%;overflow: visible;">
							<jsp:include page="/work_order/wo_platform_store/detail_list2.jsp" flush= "true" />
						</div>
					</div>
					<div role="tabpanel" class="tab-pane" id="second_tab2">
						<div id="third_tab_body" style="border:0px;padding:0px;width:100%;overflow: visible;">
							<jsp:include page="/work_order/wo_platform_store/split_list2.jsp" flush= "true" />
						</div>
					</div>
				</div>
			</div>
