...
<script type="text/javascript">
	$(function(){
		// 内容宽度，隐藏scroll
		hideYScroll("#sc_contentS2", $("#sc_titleS2").width());
		$(window).resize(function(){
			hideYScroll("#sc_contentS2", $("#sc_titleS2").width());
		});
		$("#sc_titleS2").resize(function(){
			hideYScroll("#sc_contentS2", $("#sc_titleS2").width());
		})
	})
</script>

<div id="packages_form2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="formLabel" aria-hidden="true">
				...
				<div class="row form-group">
					...
					<div class="col-md-10">
						<div class="table-border">
							<div class="table-title no-margin-top" id="sc_titleS2">
							...
							<div class="table-content-parent">
								<div class="table-content table-content-free" style="height: 200px;" id="sc_contentS2" onscroll="syntable($('#sc_titleS2'),$('#sc_contentS2'));">
