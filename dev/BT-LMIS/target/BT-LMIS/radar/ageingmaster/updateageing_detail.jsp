...
<head lang="en">
    ...
    function submit() {
        ...
        $.post('${root}control/radar/ageingdetailcontroller/updateAgeingDetail.do?'+param,
  	 			function(result){
		        	if(result.flag){
		                alert(result.msg);
		...
		<div class= "clearfix form-group no-margin-bottom no-padding-bottom no-border-bottom" >
			<div class= "no-margin-bottom no-padding-bottom no-border-bottom" style= "width: 100%;" align= "center" >
				...
				<table  style="width: auto;padding: 10px;">
					<tr>
					<input type="hidden" id="id" name="id" value="${queryParam.id}">
					...
					<tr>
						...
						<td width="200px">
							<input id="ageingValue" name="ageingValue" style="width: 200px;height: 30px;" value="${queryParam.ageingValue }" oninput='this.value=this.value.replace(/^[0]+[0-9]*$/gi,"")' >
						</td>
						<td align="left" width="100px"><label class="blue" >揽件截至时间&nbsp;:</label></td>
						<td width="200px">
							<input id="embranceCalTime" name="embranceCalTime" style="width: 200px;height: 30px;" value="${queryParam.embranceCalTime }" onkeyup="this.value=this.value.replace(/[^\d\:]/g,'')" >
						</td>
