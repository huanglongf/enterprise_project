$.fn.filterSelect = (function(){
    ...
    function initCss(){
        ...
        var csstext = '.m-input-select{display:inline-block;*display:inline;position:relative;-webkit-user-select:none;width:100%;}\
                        \n.m-input-select ul, .m-input-select li{padding:0;margin:0;}\
                        \n.m-input-select .m-input{padding-right:22px;width:100%;}\
    ...
    return function(options){
        ...
        this.each(function(i, v){
        	if(!$(this).parent().hasClass("m-input-select")) {
