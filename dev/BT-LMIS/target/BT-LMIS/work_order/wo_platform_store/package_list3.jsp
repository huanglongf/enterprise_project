...
<script type="text/javascript">
	$(function(){
		// 内容宽度，隐藏scroll
		hideYScroll("#sc_contentS3", $("#sc_titleS3").width());
		$(window).resize(function(){
			hideYScroll("#sc_contentS3", $("#sc_titleS3").width());
		});
		$("#sc_titleS3").resize(function(){
			hideYScroll("#sc_contentS3", $("#sc_titleS3").width());
		})
	})
</script>

<div id="packages_form3" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="formLabel" aria-hidden="true">
				...
				<div class="row form-group">
					...
					<div class="col-md-10">
						<div class="table-border">
							<div class="table-title no-margin-top" id="sc_titleS3">
							...
							<div class="table-content-parent">
								<div class="table-content table-content-free" style="height: 200px;" id="sc_contentS3" onscroll="syntable($('#sc_titleS3'),$('#sc_contentS3'));">
