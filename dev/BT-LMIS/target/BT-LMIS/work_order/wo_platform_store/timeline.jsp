	...
	<head>
		...
		<script type="text/javascript">
			...
			/* function getWorkOrderInfo3(obj) {
				$("#workOrderInfoSS2").children().remove();
				openIdDiv("workOrderInfoSS2",
						"/BT-LMIS/control/workOrderPlatformStoreController/workOrderHandle.do?woId="+obj+"&readonly=2");
			}
			function toShowAssociation(obj){
				var woNoStr = obj.innerHTML;
				alert(woNoStr);
				...
				$.ajax({
			        ...
			        success: function(result) {
			        	if(result.result_code="SUCCESS") {
			        		// 刷新列表
			        		$("#waybillGeneratedSS2").children().remove();
			        		var tr="";
