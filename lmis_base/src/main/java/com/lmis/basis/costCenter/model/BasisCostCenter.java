...
/** 
 * @ClassName: BasisCostCenter
 * @Description: TODO(成本中心)
 * @author codeGenerator
 * @date 2018-02-01 12:23:54
 * 
 */
public class BasisCostCenter extends PersistentObject {
	...
	@ApiModelProperty(value = "关联组织机构ID")
