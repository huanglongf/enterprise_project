...
/** 
 * @ClassName: ViewBasisFixedAssetsAllot
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-04-02 10:47:58
 * 
 */
public class ViewBasisFixedAssetsAllot {
	...
	@ApiModelProperty(value = "调拨日期开始")
	private String allotDateStart;
	public String getAllotDateStart() {
		return allotDateStart;
	}
	public void setAllotDateStart(String allotDateStart) {
		this.allotDateStart = allotDateStart;
	}
	

	@ApiModelProperty(value = "调拨日期结束")
	private String allotDateEnd;
	public String getAllotDateEnd() {
		return allotDateEnd;
	}
	public void setAllotDateEnd(String allotDateEnd) {
		this.allotDateEnd = allotDateEnd;
	}
	...
	private String orgIdFromDisplay;
	public String getOrgIdFromDisplay() {
		return orgIdFromDisplay;
	}
	public void setOrgIdFromDisplay(String orgIdFromDisplay) {
		this.orgIdFromDisplay = orgIdFromDisplay;
	}
	...
	@ApiModelProperty(value = "机构名称")
	private String orgIdToDisplay;
	public String getOrgIdToDisplay() {
		return orgIdToDisplay;
	}
	public void setOrgIdToDisplay(String orgIdToDisplay) {
		this.orgIdToDisplay = orgIdToDisplay;
	}
