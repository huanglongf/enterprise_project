package com.lmis.basis.grade.model;
...
/** 
 * @ClassName: BasisGrade
 * @Description: TODO(职级)
 * @author codeGenerator
 * @date 2018-01-19 16:11:26
 * 
 */
public class BasisGrade extends PersistentObject {
    ...
    @ApiModelProperty(value = "职级编号（逻辑主键）")
