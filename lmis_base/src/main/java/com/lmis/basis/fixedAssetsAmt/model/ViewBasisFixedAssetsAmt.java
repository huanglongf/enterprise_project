package com.lmis.basis.fixedAssetsAmt.model;
...
/** 
 * @ClassName: ViewBasisFixedAssetsAmt
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-02-26 16:49:11
 * 
 */
public class ViewBasisFixedAssetsAmt {
	...
	@ApiModelProperty(value = "固定资产科目编码")
	...
	private String timeTypeDisplay;
	public String getTimeTypeDisplay() {
		return timeTypeDisplay;
	}
	public void setTimeTypeDisplay(String timeTypeDisplay) {
		this.timeTypeDisplay = timeTypeDisplay;
	}
