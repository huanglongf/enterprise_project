package com.lmis.basis.orgStaff.model;
...
/** 
 * @ClassName: ViewBasisOrgStaff
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-01-24 14:37:51
 * 
 */
public class ViewBasisOrgStaff {
	...
	@ApiModelProperty(value = "机构ID（成本中心编码）")
	...
	private String staffCodeDisplay;
	public String getStaffCodeDisplay() {
		return staffCodeDisplay;
	}
	public void setStaffCodeDisplay(String staffCodeDisplay) {
		this.staffCodeDisplay = staffCodeDisplay;
	}
