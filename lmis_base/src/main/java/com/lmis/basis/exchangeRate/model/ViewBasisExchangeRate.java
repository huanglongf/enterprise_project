package com.lmis.basis.exchangeRate.model;
...
/** 
 * @ClassName: ViewBasisExchangeRate
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-01-18 15:00:45
 * 
 */
public class ViewBasisExchangeRate {
	...
	@ApiModelProperty(value = "汇率编号（逻辑主键）")
	...
	@ApiModelProperty(value = "源货币（编号）")
	private String recourseCurrency;
	public String getRecourseCurrency() {
		return recourseCurrency;
	}
	public void setRecourseCurrency(String recourseCurrency) {
		this.recourseCurrency = recourseCurrency;
	}
	
	@ApiModelProperty(value = "货币名称")
	private String recourseCurrencyDisplay;
	public String getRecourseCurrencyDisplay() {
		return recourseCurrencyDisplay;
	}
	public void setRecourseCurrencyDisplay(String recourseCurrencyDisplay) {
		this.recourseCurrencyDisplay = recourseCurrencyDisplay;
	}
	
	@ApiModelProperty(value = "目标货币（编号）")
	...
	@ApiModelProperty(value = "货币名称")
	private String targetCurrencyDisplay;
	public String getTargetCurrencyDisplay() {
		return targetCurrencyDisplay;
	}
	public void setTargetCurrencyDisplay(String targetCurrencyDisplay) {
		this.targetCurrencyDisplay = targetCurrencyDisplay;
	}
