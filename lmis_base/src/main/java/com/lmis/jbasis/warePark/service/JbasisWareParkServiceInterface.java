package com.lmis.jbasis.warePark.service;
...
/** 
 * @ClassName: JbasisWareParkServiceInterface
...
@Service
public interface JbasisWareParkServiceInterface<T extends PersistentObject> {
	 ...
	 * @date: 2018-04-12 09:57:26
	 */
	LmisResult<?> deleteJbasisWarePark(T t) throws Exception;

    /**
     * @return
     */
//	LmisResult<?> exportCostCenter();
}
