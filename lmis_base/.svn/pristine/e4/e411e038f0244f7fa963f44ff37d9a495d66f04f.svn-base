package com.lmis.sys.org.model;
...
/** 
 * @ClassName: ViewSysOrg
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-01-31 16:07:26
 * 
 */
public class ViewSysOrg {
	...
	@ApiModelProperty(value = "")
	private String orgByDisplay;
	public String getOrgByDisplay() {
		return orgByDisplay;
	}
	public void setOrgByDisplay(String orgByDisplay) {
		this.orgByDisplay = orgByDisplay;
	}
	...
	private List<ViewSysOrg> childList;
	public List<ViewSysOrg> getChildList() {
		return childList;
	}
	public void setChildList(List<ViewSysOrg> childList) {
