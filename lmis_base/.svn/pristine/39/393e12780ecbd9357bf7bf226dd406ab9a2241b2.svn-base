package com.lmis.basis.costCenter.model;
...
/** 
 * @ClassName: ViewBasisCostCenter
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-02-27 15:32:09
 * 
 */
public class ViewBasisCostCenter {
	...
	@ApiModelProperty(value = "启停标志 1-已禁用 0-未禁用")
	...
	@ApiModelProperty(value = "成本中心ID-逻辑主键")
	...
	@ApiModelProperty(value = "成本中心负责人，员工编码")
	...
	private String personInChargeDispaly;
	public String getPersonInChargeDispaly() {
		return personInChargeDispaly;
	}
	public void setPersonInChargeDispaly(String personInChargeDispaly) {
		this.personInChargeDispaly = personInChargeDispaly;
	}
	...
	private List<ViewBasisCostCenter> childList;
	public List<ViewBasisCostCenter> getChildList() {
		return childList;
	}
	public void setChildList(List<ViewBasisCostCenter> childList) {
