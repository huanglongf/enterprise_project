package com.lmis.basis.supplier.model;
...
/** 
 * @ClassName: ViewBasisSupplier
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-03-12 14:22:46
 * 
 */
public class ViewBasisSupplier {
	...
	@ApiModelProperty(value = "供应商编号（逻辑主键）")
	...
	private String supplierTypeDisplay;
	public String getSupplierTypeDisplay() {
		return supplierTypeDisplay;
	}
	public void setSupplierTypeDisplay(String supplierTypeDisplay) {
		this.supplierTypeDisplay = supplierTypeDisplay;
	}
