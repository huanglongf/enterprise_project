package com.lmis.basis.fixedAssets.model;
...
/** 
 * @ClassName: ViewBasisFixedAssets
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-01-23 15:17:13
 * 
 */
public class ViewBasisFixedAssets {
	...
	@ApiModelProperty(value = "固定资产科目编码（逻辑主键）")
	...
	@ApiModelProperty(value = "固定资产科目名称")
	...
	private Integer assetsSeq;
	public Integer getAssetsSeq() {
		return assetsSeq;
	}
	public void setAssetsSeq(Integer assetsSeq) {
	...
	private String assetsTypeDisplay;
	public String getAssetsTypeDisplay() {
		return assetsTypeDisplay;
	}
	public void setAssetsTypeDisplay(String assetsTypeDisplay) {
		this.assetsTypeDisplay = assetsTypeDisplay;
	}
	
	@ApiModelProperty(value = "物料性质")
	...
	public String getMaterialTypeDisplay() {
		return materialTypeDisplay;
	}
	public void setMaterialTypeDisplay(String materialTypeDisplay) {
		this.materialTypeDisplay = materialTypeDisplay;
	}
	...
	@ApiModelProperty(value = "使用寿命单位")
	private String workingLifeUnit;
	public String getWorkingLifeUnit() {
		return workingLifeUnit;
	}
	public void setWorkingLifeUnit(String workingLifeUnit) {
		this.workingLifeUnit = workingLifeUnit;
	}
	
	@ApiModelProperty(value = "常量名称")
	private String workingLifeUnitDisplay;
	public String getWorkingLifeUnitDisplay() {
		return workingLifeUnitDisplay;
	}
	public void setWorkingLifeUnitDisplay(String workingLifeUnitDisplay) {
		this.workingLifeUnitDisplay = workingLifeUnitDisplay;
	}
	...
	@ApiModelProperty(value = "残值率单位")
	private String residualRateUnit;
	public String getResidualRateUnit() {
		return residualRateUnit;
	}
	public void setResidualRateUnit(String residualRateUnit) {
		this.residualRateUnit = residualRateUnit;
	}
	
	@ApiModelProperty(value = "常量名称")
	private String residualRateUnitDisplay;
	public String getResidualRateUnitDisplay() {
		return residualRateUnitDisplay;
	}
	public void setResidualRateUnitDisplay(String residualRateUnitDisplay) {
		this.residualRateUnitDisplay = residualRateUnitDisplay;
	}
	
	@ApiModelProperty(value = "折旧原则")
	private String depreciationRule;
	public String getDepreciationRule() {
		return depreciationRule;
	}
	public void setDepreciationRule(String depreciationRule) {
		this.depreciationRule = depreciationRule;
	}
	
	@ApiModelProperty(value = "常量名称")
	private String depreciationRuleDisplay;
	public String getDepreciationRuleDisplay() {
		return depreciationRuleDisplay;
	}
	public void setDepreciationRuleDisplay(String depreciationRuleDisplay) {
		this.depreciationRuleDisplay = depreciationRuleDisplay;
	}
	
	@ApiModelProperty(value = "上级固定资产科目（编码）")
	...
	private List<ViewBasisFixedAssets> childList;
	public List<ViewBasisFixedAssets> getChildList() {
		return childList;
	}
	public void setChildList(List<ViewBasisFixedAssets> childList) {
