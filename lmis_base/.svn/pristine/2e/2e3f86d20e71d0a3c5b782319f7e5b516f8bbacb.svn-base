package com.lmis.basis.currency.model;
...
/** 
 * @ClassName: ViewBasisCurrency
 * @Description: TODO(VIEW)
 * @author codeGenerator
 * @date 2018-01-18 14:46:24
 * 
 */
public class ViewBasisCurrency {
	...
	@ApiModelProperty(value = "货币编号（逻辑主键）")
	...
	@ApiModelProperty(value = "")
	private String isMajorDisplay;
	public String getIsMajorDisplay() {
		return isMajorDisplay;
	}
	public void setIsMajorDisplay(String isMajorDisplay) {
		this.isMajorDisplay = isMajorDisplay;
	}
